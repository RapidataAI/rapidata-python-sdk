...
class ImageDimensionMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_t", "height", "width", "identifier", "visibilities"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageDimensionMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageDimensionMetadata from a dict"""
        if obj is None:
            return None
