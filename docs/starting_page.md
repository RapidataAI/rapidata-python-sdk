<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
  <h1 style="margin: 0;">Rapidata Python SDK</h1>
  <a href="https://www.python.org/downloads/">
    <img src="https://img.shields.io/badge/python-3.10+-blue.svg?style=flat-square&padding=0" alt="Python 3.10+">
  </a>
</div>

Get real humans to label your data in minutes. Create labeling jobs, compare model outputs, and collect human feedback at scale.
