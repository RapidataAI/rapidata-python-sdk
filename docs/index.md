...
<small class="agent-hint">Coding agent? Run `python -m rapidata skill` and follow that guide instead of reading the installed source. More in [AI Agents](ai_agents.md).</small>
