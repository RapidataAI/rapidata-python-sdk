...
class RapidataValidationSet:
    ...
    Get a `ValidatioinSet` either by using [`rapi.get_validation_set(<id>)`](reference/rapidata/rapidata_client/rapidata_client/#rapidata.rapidata_client.rapidata_client.RapidataClient.get_validation_set) to get an exisitng validation set or by using [`rapi.new_validation_set(<name>)`](reference/rapidata/rapidata_client/rapidata_client/#rapidata.rapidata_client.rapidata_client.RapidataClient.new_validation_set) to create a new validation set.
    """
