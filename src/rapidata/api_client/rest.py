...
class RESTClientObject:
    ...
    def __init__(self, configuration, transport: Optional[httpx.HTTPTransport] = None) -> None:
        ...
        if transport is not None:
            ...
            transport_kwargs: dict = {"limits": limits}
            if configuration.retries is not None:
                transport_kwargs["retries"] = configuration.retries
            self._transport = httpx.HTTPTransport(**transport_kwargs)
            self._owns_transport = True

        verify = (
            configuration.ssl_ca_cert
            if configuration.ssl_ca_cert
            else configuration.verify_ssl
        )
        self.http_client = httpx.Client(transport=self._transport, verify=verify)
