...
class UpdateParticipantEndpointInput(LazyValidatedModel):
    """
    ...
    lab: Optional[StrictStr] = Field(default=None, description="The lab that makes the model (e.g. \"OpenAI\", \"Black Forest Labs\"). Pass null to clear.")
    ...
    license_type: Optional[ModelLicenseType] = Field(default=None, description="The license classification of the underlying model. Pass null to clear.", alias="licenseType")
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The model's price in USD per costUnit. Pass null to clear. Set and cleared together with costUnit.")
    cost_unit: Optional[CostUnit] = Field(default=None, description="The unit cost is quoted in. Pass null to clear.", alias="costUnit")
    ...
    votes_excluded: Optional[StrictBool] = Field(default=None, description="Whether the participant's already-collected votes are dropped from the scores. Only allowed while it is disabled; enabling it resets this to false.", alias="votesExcluded")
    __properties: ClassVar[List[str]] = ["name", "family", "lab", "proprietaryName", "licenseType", "cost", "costUnit", "logo", "faucet", "votesExcluded"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateParticipantEndpointInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateParticipantEndpointInput from a dict"""
        if obj is None:
            return None
