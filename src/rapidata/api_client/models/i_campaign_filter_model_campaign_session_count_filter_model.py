...
class ICampaignFilterModelCampaignSessionCountFilterModel(LazyValidatedModel):
    """
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CampaignSessionCountFilter']):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICampaignFilterModelCampaignSessionCountFilterModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICampaignFilterModelCampaignSessionCountFilterModel from a dict"""
        if obj is None:
            return None
