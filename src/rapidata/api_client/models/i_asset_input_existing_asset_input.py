...
class IAssetInputExistingAssetInput(LazyValidatedModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_t", "name", "metadata", "identifier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAssetInputExistingAssetInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAssetInputExistingAssetInput from a dict"""
        if obj is None:
            return None
