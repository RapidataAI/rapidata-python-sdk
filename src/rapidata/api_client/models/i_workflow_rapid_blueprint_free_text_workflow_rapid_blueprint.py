...
class IWorkflowRapidBlueprintFreeTextWorkflowRapidBlueprint(LazyValidatedModel):
    """
    IWorkflowRapidBlueprintFreeTextWorkflowRapidBlueprint
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    question: StrictStr
    should_validate_response: StrictBool = Field(alias="shouldValidateResponse")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IWorkflowRapidBlueprintFreeTextWorkflowRapidBlueprint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IWorkflowRapidBlueprintFreeTextWorkflowRapidBlueprint from a dict"""
        if obj is None:
            return None
