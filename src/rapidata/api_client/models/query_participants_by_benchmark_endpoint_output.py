...
from rapidata.api_client.models.model_license_type import ModelLicenseType
...
class QueryParticipantsByBenchmarkEndpointOutput(LazyValidatedModel):
    """
    QueryParticipantsByBenchmarkEndpointOutput
    """ # noqa: E501
    ...
    lab: Optional[StrictStr] = Field(default=None, description="The lab that makes the model (e.g. \"OpenAI\", \"Black Forest Labs\"), or null if unset.")
    ...
    license_type: Optional[ModelLicenseType] = Field(default=None, description="The license classification of the underlying model, or null if not classified yet.", alias="licenseType")
    cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price of one costUnit of the model in USD, or null if the price is unknown.")
    cost_unit: Optional[CostUnit] = Field(default=None, description="The unit cost is quoted in, or null if the price is unknown.", alias="costUnit")
    ...
    votes_excluded: StrictBool = Field(description="Whether the participant's already-collected votes are dropped from the scores. Only meaningful while it is disabled.", alias="votesExcluded")
    created_at: datetime = Field(description="When the participant was added to the benchmark.", alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "name", "benchmarkId", "family", "lab", "proprietaryName", "licenseType", "cost", "costUnit", "logo", "status", "votesExcluded", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryParticipantsByBenchmarkEndpointOutput from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cost_unit (nullable) is None
        # and model_fields_set contains the field
        if self.cost_unit is None and "cost_unit" in self.model_fields_set:
            _dict['costUnit'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryParticipantsByBenchmarkEndpointOutput from a dict"""
        if obj is None:
            return None
