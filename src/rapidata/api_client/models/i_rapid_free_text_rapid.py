...
class IRapidFreeTextRapid(LazyValidatedModel):
    """
    IRapidFreeTextRapid
    """ # noqa: E501
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["_t", "question", "asset", "context", "contextAsset", "featureFlags", "id"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FreeTextRapidModel']):
            raise ValueError("must be one of enum values ('FreeTextRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidFreeTextRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidFreeTextRapid from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            "_t": obj.get("_t"),
            "question": TranslatedString.from_dict(obj["question"]) if obj.get("question") is not None else None,
