...
class IAssetMultiAsset(BaseModel):
    """
    IAssetMultiAsset
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    assets: List[IAsset]
    metadata: Optional[Dict[str, IMetadata]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IAssetMultiAsset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IAssetMultiAsset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "_t": obj.get("_t"),
            "assets": [IAsset.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
            "metadata": dict(
...
IAssetMultiAsset.model_rebuild(raise_errors=False)
