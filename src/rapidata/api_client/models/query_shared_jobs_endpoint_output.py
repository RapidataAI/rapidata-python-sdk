...
class QuerySharedJobsEndpointOutput(LazyValidatedModel):
    """
    ...
    organization_id: StrictStr = Field(description="The id of the organization that owns the job.", alias="organizationId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuerySharedJobsEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuerySharedJobsEndpointOutput from a dict"""
        if obj is None:
            return None
