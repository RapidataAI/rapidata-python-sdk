...
class CreateSimpleFlowEndpointInput(LazyValidatedModel):
    ...
    responses_required: Optional[StrictInt] = Field(default=None, description="The number of responses collected per datapoint. Defaults to 5.", alias="responsesRequired")
    max_datapoints_per_item: Optional[StrictInt] = Field(default=None, description="The maximum number of datapoints a dataset may hold to be added as an item. Between 1 and 100, defaults to 24.", alias="maxDatapointsPerItem")
    ...
    target_response_count: Optional[StrictInt] = Field(default=None, description="Target average response count per completed item. Defaults to ResponsesRequired times MaxDatapointsPerItem.", alias="targetResponseCount")
    ...
    __properties: ClassVar[List[str]] = ["name", "blueprint", "responsesRequired", "maxDatapointsPerItem", "defaultTimeToLiveSeconds", "audienceId", "validationSetId", "serveToResponseRatio", "serveTimeoutSeconds", "featureFlags", "targetResponseCount", "pidProportionalGain", "pidIntegralGain", "pidDerivativeGain", "pidOutputOffset", "pidMinSessionsPerMinute", "pidMaxSessionsPerMinute", "pidBatchMode", "drainDurationSeconds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if max_datapoints_per_item (nullable) is None
        # and model_fields_set contains the field
        if self.max_datapoints_per_item is None and "max_datapoints_per_item" in self.model_fields_set:
            _dict['maxDatapointsPerItem'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = {
            ...
            "maxDatapointsPerItem": obj.get("maxDatapointsPerItem"),
