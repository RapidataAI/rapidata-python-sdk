...
class CreateSimpleFlowEndpointInput(LazyValidatedModel):
    ...
    target_response_count: Optional[StrictInt] = Field(default=None, description="Target average response count per completed item for PID rate control. Defaults to ResponsesRequired times 24, a typical batch.", alias="targetResponseCount")
    ...
    __properties: ClassVar[List[str]] = ["name", "blueprint", "responsesRequired", "defaultTimeToLiveSeconds", "audienceId", "validationSetId", "serveToResponseRatio", "serveTimeoutSeconds", "featureFlags", "targetResponseCount", "pidProportionalGain", "pidIntegralGain", "pidDerivativeGain", "pidOutputOffset", "pidMinSessionsPerMinute", "pidMaxSessionsPerMinute", "pidBatchMode", "drainDurationSeconds"]
