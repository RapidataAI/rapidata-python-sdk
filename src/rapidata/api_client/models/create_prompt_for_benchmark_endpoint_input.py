...
from rapidata.api_client.models.origin import Origin
...
class CreatePromptForBenchmarkEndpointInput(LazyValidatedModel):
    """
    CreatePromptForBenchmarkEndpointInput
    """ # noqa: E501
    identifier: StrictStr = Field(description="An identifier associated with the prompt.")
    segments: Optional[List[PromptSegmentInput]] = None
    tags: Optional[List[Tag]] = None
    origin: Optional[Origin] = Field(default=None, description="Where the prompt came from.")
    __properties: ClassVar[List[str]] = ["identifier", "segments", "tags", "origin"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePromptForBenchmarkEndpointInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePromptForBenchmarkEndpointInput from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            ...
            "segments": [PromptSegmentInput.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None,
