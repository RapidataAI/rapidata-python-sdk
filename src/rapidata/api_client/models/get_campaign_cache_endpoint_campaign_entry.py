...
class GetCampaignCacheEndpointCampaignEntry(LazyValidatedModel):
    ...
    user_score_dimension_count: StrictInt = Field(alias="userScoreDimensionCount")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCampaignCacheEndpointCampaignEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCampaignCacheEndpointCampaignEntry from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            ...
            "filterCount": obj.get("filterCount"),
            "selectionCount": obj.get("selectionCount"),
            "userScoreDimensionCount": obj.get("userScoreDimensionCount"),
