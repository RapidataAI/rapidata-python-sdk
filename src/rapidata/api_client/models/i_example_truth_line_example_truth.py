...
class IExampleTruthLineExampleTruth(LazyValidatedModel):
    """
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LineExampleTruth']):
            raise ValueError("must be one of enum values ('LineExampleTruth')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IExampleTruthLineExampleTruth from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if bounding_boxes (nullable) is None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IExampleTruthLineExampleTruth from a dict"""
        if obj is None:
            return None
