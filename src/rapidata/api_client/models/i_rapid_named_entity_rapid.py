...
class IRapidNamedEntityRapid(LazyValidatedModel):
    """
    IRapidNamedEntityRapid
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    target: TranslatedString
    classes: List[TranslatedString]
    asset: IAsset
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["_t", "target", "classes", "asset", "context", "contextAsset", "featureFlags", "id"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NamedEntityRapidModel']):
            raise ValueError("must be one of enum values ('NamedEntityRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidNamedEntityRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidNamedEntityRapid from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            ...
            "classes": [TranslatedString.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None,
