...
class QueryOwnerTierOverridesEndpointOutput(LazyValidatedModel):
    ...
    pattern: Optional[StrictStr] = Field(default=None, description="The owner-email pattern the override applies to, or null when it targets an organization.")
    organization_id: Optional[StrictStr] = Field(default=None, description="The id of the organization the override applies to, or null when it targets an email pattern.", alias="organizationId")
    ...
    __properties: ClassVar[List[str]] = ["id", "pattern", "organizationId", "priorityOverride", "boostOverride", "ownerMail", "createdAt"]
