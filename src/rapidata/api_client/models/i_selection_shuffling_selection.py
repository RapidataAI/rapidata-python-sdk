...
class ISelectionShufflingSelection(LazyValidatedModel):
    """
    ISelectionShufflingSelection
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    selections: List[ISelection]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ISelectionShufflingSelection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ISelectionShufflingSelection from a dict"""
        if obj is None:
            return None
...
ISelectionShufflingSelection.model_rebuild(raise_errors=False)
