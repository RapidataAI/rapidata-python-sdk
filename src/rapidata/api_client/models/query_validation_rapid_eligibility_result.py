...
class QueryValidationRapidEligibilityResult(BaseModel):
    ...
    truth: QueryValidationRapidEligibilityResultTruth
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryValidationRapidEligibilityResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryValidationRapidEligibilityResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "truth": QueryValidationRapidEligibilityResultTruth.from_dict(obj["truth"]) if obj.get("truth") is not None else None
        })
        return _obj
