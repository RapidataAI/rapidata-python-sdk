...
class GetSampleGenerationEndpointOutput(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "benchmarkId", "status", "samplesPerPrompt", "totalCount", "completedCount", "failedCount", "failureBreakdown", "participantFilter", "promptIdentifierFilter", "tagsFilter", "ownerId", "ownerMail", "organizationId", "createdAt"]
