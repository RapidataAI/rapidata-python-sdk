...
class UpdateAudienceExampleEndpointInput(LazyValidatedModel):
    ...
    instruction_text: Optional[StrictStr] = Field(default=None, description="The instruction shown to the user — the criteria for a compare example, the target  for a locate, line or scrub example, or the title for a classify or transcription  example. The example's answer options are left unchanged.", alias="instructionText")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateAudienceExampleEndpointInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAudienceExampleEndpointInput from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            ...
            "instructionText": obj.get("instructionText"),
