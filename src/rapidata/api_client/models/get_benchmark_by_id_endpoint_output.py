...
class GetBenchmarkByIdEndpointOutput(LazyValidatedModel):
    ...
    initial_boost_level: Optional[StrictInt] = Field(description="Initial boost level applied to every run's campaign; null uses the benchmark default.", alias="initialBoostLevel")
    score_shift: Union[StrictFloat, StrictInt] = Field(description="Additive offset applied to displayed scores on the benchmark's overall scoreboard.", alias="scoreShift")
    score_scale: Union[StrictFloat, StrictInt] = Field(description="Multiplicative factor applied to displayed scores on the benchmark's overall scoreboard,  relative to the Bradley-Terry center.", alias="scoreScale")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "isPublic", "isPublished", "createdAt", "ownerId", "ownerMail", "organizationId", "initialBoostLevel", "scoreShift", "scoreScale", "lastUpdatedAt", "promptStructure"]
