...
class GetActiveBillingPeriodOverviewEndpointOutput(LazyValidatedModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "organizationId", "startDate", "endDate", "status", "totalGrossCost", "totalDiscount", "totalNetCost", "totalResponseCount", "lineItems"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetActiveBillingPeriodOverviewEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetActiveBillingPeriodOverviewEndpointOutput from a dict"""
        if obj is None:
            return None
