...
class ICampaignFilterUserActionRestrictionFilter(LazyValidatedModel):
    """
    ICampaignFilterUserActionRestrictionFilter
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    required_actions: Optional[Any] = Field(alias="requiredActions")
    __properties: ClassVar[List[str]] = ["_t", "requiredActions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICampaignFilterUserActionRestrictionFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICampaignFilterUserActionRestrictionFilter from a dict"""
        if obj is None:
            return None
