...
from rapidata.api_client.models.get_workflow_results_endpoint_response_output import GetWorkflowResultsEndpointResponseOutput
...
class GetWorkflowResultsEndpointOutput(LazyValidatedModel):
    """
    GetWorkflowResultsEndpointOutput
    """ # noqa: E501
    ...
    responses: List[GetWorkflowResultsEndpointResponseOutput]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWorkflowResultsEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWorkflowResultsEndpointOutput from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            ...
            "responses": [GetWorkflowResultsEndpointResponseOutput.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
