...
class CreateManualChargeEndpointInput(LazyValidatedModel):
    ...
    organization_id: StrictStr = Field(description="The customer to charge.", alias="organizationId")
    customer_id: UUID = Field(description="The member the charge is recorded against, for auditability.", alias="customerId")
