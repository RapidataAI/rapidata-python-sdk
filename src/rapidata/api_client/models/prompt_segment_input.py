...
class PromptSegmentInput(LazyValidatedModel):
    """
    PromptSegmentInput
    """ # noqa: E501
    key: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["key", "kind", "text", "asset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PromptSegmentInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PromptSegmentInput from a dict"""
        if obj is None:
            return None
