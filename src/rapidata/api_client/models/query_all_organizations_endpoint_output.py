...
class QueryAllOrganizationsEndpointOutput(LazyValidatedModel):
    ...
    owner_email: Optional[StrictStr] = Field(description="The email of the organization's owner, absent when it has no active owner.", alias="ownerEmail")
    owner_count: StrictInt = Field(description="The number of owners the organization has.", alias="ownerCount")
    __properties: ClassVar[List[str]] = ["id", "name", "memberCount", "ownerEmail", "ownerCount"]
