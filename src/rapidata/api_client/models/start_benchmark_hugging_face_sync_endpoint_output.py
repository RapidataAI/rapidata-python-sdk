...
class StartBenchmarkHuggingFaceSyncEndpointOutput(LazyValidatedModel):
    ...
    forced_full_rebuild: StrictBool = Field(description="Whether the attempt was promoted to a full rebuild because the export configuration  differs from the one the dataset was last built with.", alias="forcedFullRebuild")
