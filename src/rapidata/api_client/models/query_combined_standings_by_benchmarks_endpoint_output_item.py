...
class QueryCombinedStandingsByBenchmarksEndpointOutputItem(LazyValidatedModel):
    """
    QueryCombinedStandingsByBenchmarksEndpointOutputItem
    """ # noqa: E501
    id: StrictStr
    name: StrictStr
    ...
    license_type: Optional[ModelLicenseType] = Field(default=None, alias="licenseType")
    cost: Optional[Union[StrictFloat, StrictInt]] = None
    cost_unit: Optional[CostUnit] = Field(default=None, alias="costUnit")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "family", "lab", "proprietaryName", "licenseType", "cost", "costUnit", "logo", "status", "score", "wins", "totalMatches", "responseCount", "isDisabled", "confidenceInterval"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryCombinedStandingsByBenchmarksEndpointOutputItem from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.confidence_interval is None and "confidence_interval" in self.model_fields_set:
            _dict['confidenceInterval'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryCombinedStandingsByBenchmarksEndpointOutputItem from a dict"""
        if obj is None:
            return None
