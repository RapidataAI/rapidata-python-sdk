...
class QueryCombinedStandingsByBenchmarksEndpointOutputItem(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "family", "lab", "proprietaryName", "licenseType", "logo", "status", "score", "wins", "totalMatches", "responseCount", "isDisabled", "confidenceInterval"]
