...
class GetBoostInsightsEndpointLanguageBoostOutput(LazyValidatedModel):
    """
    GetBoostInsightsEndpointLanguageBoostOutput
    """ # noqa: E501
    language: StrictStr
    contributors: List[GetBoostInsightsEndpointContributorOutput]
    __properties: ClassVar[List[str]] = ["language", "contributors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBoostInsightsEndpointLanguageBoostOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBoostInsightsEndpointLanguageBoostOutput from a dict"""
        if obj is None:
            return None
