...
class GetJobByIdEndpointOutput(LazyValidatedModel):
    ...
    audience_name: Optional[StrictStr] = Field(default=None, description="The audience name, or null when the job's audience has since been deleted (jobs  outlive their audience).", alias="audienceName")
    ...
    __properties: ClassVar[List[str]] = ["jobId", "name", "definitionId", "audienceId", "revisionNumber", "pipelineId", "audienceName", "state", "isPublic", "audienceDeleted", "completedAt", "resultFileName", "failedAt", "failureMessage", "reviewReason", "createdAt", "ownerId", "ownerMail", "organizationId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if audience_name (nullable) is None
        # and model_fields_set contains the field
        if self.audience_name is None and "audience_name" in self.model_fields_set:
            _dict['audienceName'] = None
