...
class QueryMatchupsByBenchmarkEndpointOutputSide(LazyValidatedModel):
    """
    QueryMatchupsByBenchmarkEndpointOutputSide
    """ # noqa: E501
    ...
    theta: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["sampleId", "participantId", "participantName", "asset", "responses", "wins", "theta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryMatchupsByBenchmarkEndpointOutputSide from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryMatchupsByBenchmarkEndpointOutputSide from a dict"""
        if obj is None:
            return None
