...
class IRapidLocateRapid(LazyValidatedModel):
    """
    IRapidLocateRapid
    """ # noqa: E501
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LocateRapidModel']):
            raise ValueError("must be one of enum values ('LocateRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidLocateRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidLocateRapid from a dict"""
        if obj is None:
            return None
