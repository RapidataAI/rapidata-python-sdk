...
class ICampaignSelectionShufflingSelection(LazyValidatedModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICampaignSelectionShufflingSelection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICampaignSelectionShufflingSelection from a dict"""
        if obj is None:
            return None
...
ICampaignSelectionShufflingSelection.model_rebuild(raise_errors=False)
