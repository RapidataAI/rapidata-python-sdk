...
class PagedResultGetGroupedRankingWorkflowResultsResult(BaseModel):
    """
    PagedResultGetGroupedRankingWorkflowResultsResult
    """ # noqa: E501
    total: StrictInt
    page: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagedResultGetGroupedRankingWorkflowResultsResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagedResultGetGroupedRankingWorkflowResultsResult from a dict"""
        if obj is None:
            return None
