...
class QueryBenchmarkStandingsEndpointOutput(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "family", "lab", "proprietaryName", "licenseType", "logo", "benchmarkId", "status", "score", "wins", "totalMatches", "isDisabled", "confidenceInterval"]
