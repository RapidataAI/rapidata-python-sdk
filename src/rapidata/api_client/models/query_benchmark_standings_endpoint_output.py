...
class QueryBenchmarkStandingsEndpointOutput(LazyValidatedModel):
    """
    QueryBenchmarkStandingsEndpointOutput
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "family", "lab", "proprietaryName", "licenseType", "cost", "costUnit", "logo", "benchmarkId", "status", "score", "wins", "totalMatches", "isDisabled", "confidenceInterval"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryBenchmarkStandingsEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryBenchmarkStandingsEndpointOutput from a dict"""
        if obj is None:
            return None
