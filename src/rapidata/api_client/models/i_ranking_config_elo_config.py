...
class IRankingConfigEloConfig(LazyValidatedModel):
    """
    IRankingConfigEloConfig
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_t", "startingElo", "startingScore", "kFactor", "scalingFactor"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['EloConfig']):
            raise ValueError("must be one of enum values ('EloConfig')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRankingConfigEloConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRankingConfigEloConfig from a dict"""
        if obj is None:
            return None
