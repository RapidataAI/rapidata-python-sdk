...
class IWorkflowConfigGroupedRankingWorkflowConfig(LazyValidatedModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_t", "criteria", "referee", "targetCountryCodes", "maxParallelism", "contexts", "contextAssets", "eloConfig", "rankingConfig", "pairMakerConfig", "featureFlags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IWorkflowConfigGroupedRankingWorkflowConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IWorkflowConfigGroupedRankingWorkflowConfig from a dict"""
        if obj is None:
            return None
