...
class ICampaignSelectionAudienceSelection(LazyValidatedModel):
    """
    ICampaignSelectionAudienceSelection
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_t", "audienceId", "effort", "retrievalMode", "maxIterations"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AudienceSelection']):
            raise ValueError("must be one of enum values ('AudienceSelection')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICampaignSelectionAudienceSelection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICampaignSelectionAudienceSelection from a dict"""
        if obj is None:
            return None
