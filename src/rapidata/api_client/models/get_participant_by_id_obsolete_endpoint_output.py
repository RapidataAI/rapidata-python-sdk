...
class GetParticipantByIdObsoleteEndpointOutput(LazyValidatedModel):
    """
    GetParticipantByIdObsoleteEndpointOutput
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the standing.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetParticipantByIdObsoleteEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetParticipantByIdObsoleteEndpointOutput from a dict"""
        if obj is None:
            return None
