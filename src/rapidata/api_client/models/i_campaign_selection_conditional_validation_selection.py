...
class ICampaignSelectionConditionalValidationSelection(LazyValidatedModel):
    """
    ICampaignSelectionConditionalValidationSelection
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICampaignSelectionConditionalValidationSelection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICampaignSelectionConditionalValidationSelection from a dict"""
        if obj is None:
            return None
...
ICampaignSelectionConditionalValidationSelection.model_rebuild(raise_errors=False)
