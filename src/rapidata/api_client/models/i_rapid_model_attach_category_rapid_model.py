...
from rapidata.api_client.models.attach_category_rapid_model_category import AttachCategoryRapidModelCategory
...
class IRapidModelAttachCategoryRapidModel(LazyValidatedModel):
    """
    IRapidModelAttachCategoryRapidModel
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    categories: List[AttachCategoryRapidModelCategory]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidModelAttachCategoryRapidModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidModelAttachCategoryRapidModel from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            "_t": obj.get("_t"),
            "categories": [AttachCategoryRapidModelCategory.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
