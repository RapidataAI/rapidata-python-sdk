...
class GetRapidNavigationEndpointCardResponse(LazyValidatedModel):
    """
    GetRapidNavigationEndpointCardResponse
    """ # noqa: E501
    id: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetRapidNavigationEndpointCardResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetRapidNavigationEndpointCardResponse from a dict"""
        if obj is None:
            return None
