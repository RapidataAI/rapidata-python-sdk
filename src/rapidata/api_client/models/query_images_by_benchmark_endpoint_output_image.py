...
class QueryImagesByBenchmarkEndpointOutputImage(LazyValidatedModel):
    """
    QueryImagesByBenchmarkEndpointOutputImage
    """ # noqa: E501
    ...
    rank: StrictInt
    __properties: ClassVar[List[str]] = ["sampleId", "participantId", "participantName", "label", "asset", "responseCount", "rating", "rank"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryImagesByBenchmarkEndpointOutputImage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryImagesByBenchmarkEndpointOutputImage from a dict"""
        if obj is None:
            return None
