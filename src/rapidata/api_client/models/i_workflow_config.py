...
class IWorkflowConfig(LazyValidatedModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, IWorkflowConfigEvaluationWorkflowConfig):
            ...
            match += 1
        # validate data type: IWorkflowConfigGroupedRankingWorkflowConfig
        if not isinstance(v, IWorkflowConfigGroupedRankingWorkflowConfig):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into IWorkflowConfigGroupedRankingWorkflowConfig
        try:
            instance.actual_instance = IWorkflowConfigGroupedRankingWorkflowConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
