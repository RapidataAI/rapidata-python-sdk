...
class IRapidBoundingBoxRapid(LazyValidatedModel):
    """
    IRapidBoundingBoxRapid
    """ # noqa: E501
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["_t", "target", "asset", "context", "contextAsset", "featureFlags", "id"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BoundingBoxRapidModel']):
            raise ValueError("must be one of enum values ('BoundingBoxRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidBoundingBoxRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidBoundingBoxRapid from a dict"""
        if obj is None:
            return None
