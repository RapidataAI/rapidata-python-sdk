...
class QueryLeaderboardsByBenchmarkEndpointOutput(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "instruction", "showPrompt", "showPromptAsset", "isInversed", "responseBudget", "minResponses", "audienceId", "jobDefinitionId", "featureFlags", "weight", "scoreShift", "scoreScale", "isHidden", "isExcludedFromOverall", "includedTags", "excludedTags"]
