...
class IRapidCompareRapid(LazyValidatedModel):
    """
    IRapidCompareRapid
    """ # noqa: E501
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["_t", "criteria", "asset", "context", "contextAsset", "featureFlags", "id"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CompareRapidModel']):
            raise ValueError("must be one of enum values ('CompareRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidCompareRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidCompareRapid from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            "_t": obj.get("_t"),
            "criteria": TranslatedString.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None,
