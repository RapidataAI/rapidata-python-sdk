...
class ICampaignFilterModelAndFilterModel(LazyValidatedModel):
    """
    ICampaignFilterModelAndFilterModel
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ICampaignFilterModelAndFilterModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ICampaignFilterModelAndFilterModel from a dict"""
        if obj is None:
            return None
...
ICampaignFilterModelAndFilterModel.model_rebuild(raise_errors=False)
