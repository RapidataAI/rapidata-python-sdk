...
class CreateSimpleFlowItemEndpointInput(LazyValidatedModel):
    ...
    time_to_live_in_seconds: Optional[StrictInt] = Field(default=None, description="Optional time-to-live in seconds before the flow item expires. Must be between 45 seconds and 1 hour, and must exceed the drain duration by at least 30 seconds; defaults to the flow's default when omitted.", alias="timeToLiveInSeconds")
