...
class GetJobResponsesEndpointOutputResponse(LazyValidatedModel):
    """
    GetJobResponsesEndpointOutputResponse
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "userId", "country", "language", "age", "gender", "occupation", "result", "userScore", "userScores", "demographicInformation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetJobResponsesEndpointOutputResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetJobResponsesEndpointOutputResponse from a dict"""
        if obj is None:
            return None
