...
class SubmitFeedbackEndpointInput(LazyValidatedModel):
    """
    ...
    token: Optional[StrictStr] = Field(default=None, description="The recaptcha token, required when the caller is not authenticated.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitFeedbackEndpointInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitFeedbackEndpointInput from a dict"""
        if obj is None:
            return None
