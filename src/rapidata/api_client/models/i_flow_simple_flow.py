...
class IFlowSimpleFlow(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["_t", "id", "name", "campaignId", "flowItemCount", "targetResponseCount", "pidProportionalGain", "pidIntegralGain", "pidDerivativeGain", "pidOutputOffset", "pidMinSessionsPerMinute", "pidMaxSessionsPerMinute", "pidBatchMode", "serveTimeoutSeconds", "drainDurationSeconds", "serveToResponseRatio", "blueprint", "responsesRequired", "defaultTimeToLiveSeconds", "featureFlags", "ownerId", "ownerMail", "organizationId", "createdAt"]
