...
class IFlowSimpleFlow(LazyValidatedModel):
    """
    IFlowSimpleFlow
    """ # noqa: E501
    ...
    responses_required: StrictInt = Field(description="The number of responses collected per datapoint.", alias="responsesRequired")
    max_datapoints_per_item: StrictInt = Field(description="The maximum number of datapoints a dataset may hold to be added as an item.", alias="maxDatapointsPerItem")
    ...
    __properties: ClassVar[List[str]] = ["_t", "id", "name", "campaignId", "flowItemCount", "targetResponseCount", "pidProportionalGain", "pidIntegralGain", "pidDerivativeGain", "pidOutputOffset", "pidMinSessionsPerMinute", "pidMaxSessionsPerMinute", "pidBatchMode", "serveTimeoutSeconds", "drainDurationSeconds", "serveToResponseRatio", "blueprint", "responsesRequired", "maxDatapointsPerItem", "defaultTimeToLiveSeconds", "featureFlags", "ownerId", "ownerMail", "organizationId", "createdAt"]

    @field_validator('t')
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SimpleFlow']):
            raise ValueError("must be one of enum values ('SimpleFlow')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IFlowSimpleFlow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IFlowSimpleFlow from a dict"""
        if obj is None:
            return None
