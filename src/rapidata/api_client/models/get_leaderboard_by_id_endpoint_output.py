...
class GetLeaderboardByIdEndpointOutput(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "instruction", "showPrompt", "showPromptAsset", "isInversed", "responseBudget", "minResponses", "audienceId", "jobDefinitionId", "priority", "featureFlags", "weight", "scoreShift", "scoreScale", "isHidden", "isExcludedFromOverall", "voteAggregation", "includedTags", "excludedTags"]
