...
class QueryRapidsForAudienceResult(BaseModel):
    """
    QueryRapidsForAudienceResult
    """ # noqa: E501
    id: StrictStr
    type: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryRapidsForAudienceResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryRapidsForAudienceResult from a dict"""
        if obj is None:
            return None
