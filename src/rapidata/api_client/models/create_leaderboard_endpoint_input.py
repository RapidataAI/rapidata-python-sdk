...
class CreateLeaderboardEndpointInput(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["benchmarkId", "benchmarkName", "benchmarkDescription", "name", "instruction", "showPrompt", "showPromptAsset", "responseBudget", "minResponses", "isInversed", "audienceId", "priority", "weight", "scoreShift", "scoreScale", "isHidden", "isExcludedFromOverall", "voteAggregation", "includedTags", "excludedTags", "featureFlags"]
