...
class GetBenchmarkStandingsBreakdownEndpointOutputOutputItem(LazyValidatedModel):
    """
    GetBenchmarkStandingsBreakdownEndpointOutputOutputItem
    """ # noqa: E501
    id: StrictStr
    name: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "family", "lab", "proprietaryName", "licenseType", "cost", "costUnit", "logo", "status", "score", "wins", "totalMatches", "isDisabled", "confidenceInterval"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBenchmarkStandingsBreakdownEndpointOutputOutputItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBenchmarkStandingsBreakdownEndpointOutputOutputItem from a dict"""
        if obj is None:
            return None
