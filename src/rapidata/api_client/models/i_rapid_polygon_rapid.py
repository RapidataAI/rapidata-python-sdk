...
class IRapidPolygonRapid(LazyValidatedModel):
    """
    IRapidPolygonRapid
    """ # noqa: E501
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolygonRapidModel']):
            raise ValueError("must be one of enum values ('PolygonRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidPolygonRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidPolygonRapid from a dict"""
        if obj is None:
            return None
