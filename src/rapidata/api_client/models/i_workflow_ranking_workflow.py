...
class IWorkflowRankingWorkflow(LazyValidatedModel):
    """
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RankingWorkflowModel']):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IWorkflowRankingWorkflow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IWorkflowRankingWorkflow from a dict"""
        if obj is None:
            return None
