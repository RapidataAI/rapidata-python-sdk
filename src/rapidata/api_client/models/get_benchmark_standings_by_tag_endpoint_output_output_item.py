...
class GetBenchmarkStandingsByTagEndpointOutputOutputItem(LazyValidatedModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "family", "lab", "proprietaryName", "licenseType", "logo", "status", "score", "wins", "totalMatches", "responseCount", "isEvaluating", "isDisabled", "confidenceInterval"]
