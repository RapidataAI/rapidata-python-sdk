...
class StartBulkReconciliationEndpointInput(LazyValidatedModel):
    ...
    organization_id: StrictStr = Field(description="The organization the reconciliation is scoped to.", alias="organizationId")
    ...
    __properties: ClassVar[List[str]] = ["billingItemId", "organizationId", "customerId", "billingGroupId", "startDate", "endDate", "timestampMode"]
