...
class IExampleTruthTranscriptionExampleTruth(LazyValidatedModel):
    """
    IExampleTruthTranscriptionExampleTruth
    """ # noqa: E501
    t: StrictStr = Field(alias="_t")
    correct_words: List[ExampleTranscriptionWord] = Field(alias="correctWords")
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TranscriptionExampleTruth']):
            raise ValueError("must be one of enum values ('TranscriptionExampleTruth')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IExampleTruthTranscriptionExampleTruth from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IExampleTruthTranscriptionExampleTruth from a dict"""
        if obj is None:
            return None
        ...
        _data = {
            "_t": obj.get("_t"),
            "correctWords": [ExampleTranscriptionWord.from_dict(_item) for _item in obj["correctWords"]] if obj.get("correctWords") is not None else None,
