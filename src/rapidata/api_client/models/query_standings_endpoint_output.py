...
class QueryStandingsEndpointOutput(LazyValidatedModel):
    """
    QueryStandingsEndpointOutput
    """ # noqa: E501
    ...
    leaderboard_id: StrictStr = Field(description="The id of the leaderboard this standing belongs to.", alias="leaderboardId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryStandingsEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryStandingsEndpointOutput from a dict"""
        if obj is None:
            return None
