...
class GetAudienceByIdEndpointOutput(LazyValidatedModel):
    ...
    base_audience_id: StrictStr = Field(description="The audience that backs this entry. Equals id for a regular audience; for a  filtered audience it points to the audience the filter is applied on top of.", alias="baseAudienceId")
    filter: Optional[IAudienceFilter] = Field(default=None, description="The filter applied on top of the base audience. Null for a regular audience — a  non-null value is the sole signal that this is a filtered view. Every other field  describes the base audience, since a filtered view inherits its configuration and has  no user counts of its own.")
    ...
    health: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The health score of the audience: the share of graduates beyond what random clicking  would produce. Null when nothing has been measured yet.")
    judged_share: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The share of finished users that received an accuracy verdict from their own answers,  rather than leaving through a session limit, low submission rate or a global drop.  Null when no user has finished.", alias="judgedShare")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if judged_share (nullable) is None
        # and model_fields_set contains the field
        if self.judged_share is None and "judged_share" in self.model_fields_set:
            _dict['judgedShare'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = {
            "id": obj.get("id"),
            "baseAudienceId": obj.get("baseAudienceId"),
            ...
            "judgedShare": obj.get("judgedShare"),
