...
class QuerySampleGenerationsByBenchmarkEndpointOutput(LazyValidatedModel):
    """
    QuerySampleGenerationsByBenchmarkEndpointOutput
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "benchmarkId", "status", "mode", "samplesPerPrompt", "totalCount", "completedCount", "failedCount", "participantIdFilter", "promptIdentifierFilter", "tagsFilter", "ownerId", "ownerMail", "organizationId", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuerySampleGenerationsByBenchmarkEndpointOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuerySampleGenerationsByBenchmarkEndpointOutput from a dict"""
        if obj is None:
            return None
