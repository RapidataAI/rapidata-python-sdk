...
class ReadBridgeTokenEndpointKeysOutput(LazyValidatedModel):
    """
    ...
    scope: Optional[StrictStr] = Field(description="The scopes granted to the issued token.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReadBridgeTokenEndpointKeysOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReadBridgeTokenEndpointKeysOutput from a dict"""
        if obj is None:
            return None
