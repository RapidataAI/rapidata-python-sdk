...
class CreateAudienceEndpointInput(LazyValidatedModel):
    ...
    distilling_retrieval_mode: Optional[DistillingRetrievalMode] = Field(default=None, description="The retrieval mode used by the distilling campaign to select rapids for users.  Defaults to Shuffled.", alias="distillingRetrievalMode")
