...
class IRapidLineRapid(LazyValidatedModel):
    """
    IRapidLineRapid
    """ # noqa: E501
    ...
    def t_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LineRapidModel']):
            raise ValueError("must be one of enum values ('LineRapidModel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IRapidLineRapid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IRapidLineRapid from a dict"""
        if obj is None:
            return None
