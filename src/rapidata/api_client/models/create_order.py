...
class CreateOrder(LazyValidatedModel):
    """
    ...
    workflow: IOrderWorkflowInput = Field(description="The workflow helps to determine the tasks that need to be completed by the users.")
    referee: IReferee = Field(description="The referee is used to determine how many votes will be collected.")
    ...
    user_filters: Optional[List[IUserFilter]] = Field(default=None, alias="userFilters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _data = {
            ...
            "userFilters": [IUserFilter.from_dict(_item) for _item in obj["userFilters"]] if obj.get("userFilters") is not None else None,
