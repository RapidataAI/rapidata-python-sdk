...
from rapidata.api_client.models.i_workflow_rapid_blueprint import IWorkflowRapidBlueprint
...
class IWorkflowSimpleWorkflow(LazyValidatedModel):
    """
    ...
    id: StrictStr
    state: WorkflowState
    blueprint: IWorkflowRapidBlueprint
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IWorkflowSimpleWorkflow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IWorkflowSimpleWorkflow from a dict"""
        if obj is None:
            return None
