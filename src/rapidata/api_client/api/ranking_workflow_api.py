...
from typing_extensions import Annotated
from rapidata.api_client.models.get_ranking_workflow_results_model import GetRankingWorkflowResultsModel
from rapidata.api_client.models.get_ranking_workflow_results_result import GetRankingWorkflowResultsResult
...
class RankingWorkflowApi:
    ...
    def workflow_compare_workflow_id_results_get(
        ...
        model: Annotated[Optional[GetRankingWorkflowResultsModel], Field(description="The model for the request.")] = None,
        ...
        :type model: GetRankingWorkflowResultsModel
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetRankingWorkflowResultsResult",
        }
    ...
    def workflow_compare_workflow_id_results_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetRankingWorkflowResultsResult]:
        """Get the result overview for a ranking workflow.
