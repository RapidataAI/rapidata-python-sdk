...
from typing_extensions import Annotated
from rapidata.api_client.models.get_workflow_results_endpoint_paged_result_of_output import GetWorkflowResultsEndpointPagedResultOfOutput
...
class EvaluationApi:
    ...
    def workflow_evaluation_workflow_id_results_get(
        ...
        states: Annotated[Optional[List[RapidState]], Field(description="Optional list of rapid states to filter by. If not provided, all states are included.")] = None,
    ...
    ) -> GetWorkflowResultsEndpointPagedResultOfOutput:
        """Gets the results for an evaluation workflow.


        :param workflow_id: The ID of the workflow to get the results for. (required)
        :type workflow_id: str
        :param states: Optional list of rapid states to filter by. If not provided, all states are included.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetWorkflowResultsEndpointPagedResultOfOutput",
    ...
    def workflow_evaluation_workflow_id_results_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWorkflowResultsEndpointPagedResultOfOutput]:
        """Gets the results for an evaluation workflow.
