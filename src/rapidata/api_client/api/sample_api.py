...
class SampleApi:
    ...
    def benchmark_sample_sample_id_navigation_get(
        ...
        related_limit: Annotated[Optional[StrictInt], Field(description="The maximum number of related samples to return.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type sample_id: str
        :param related_limit: The maximum number of related samples to return.
        :type related_limit: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _benchmark_sample_sample_id_navigation_get_serialize(
        ...
        if related_limit is not None:
            ...
            _query_params.append(('relatedLimit', related_limit))
