...
from rapidata.api_client.models.create_order_definition_model import CreateOrderDefinitionModel
from rapidata.api_client.models.create_order_definition_result import CreateOrderDefinitionResult
from rapidata.api_client.models.create_order_definition_revision_model import CreateOrderDefinitionRevisionModel
from rapidata.api_client.models.create_order_definition_revision_result import CreateOrderDefinitionRevisionResult
...
class OrderApi:
    ...
    @validate_call
    def order_definition_definition_id_revision_post(
        self,
        definition_id: Annotated[StrictStr, Field(description="The id of the definition this revision should belong to")],
        create_order_definition_revision_model: Annotated[CreateOrderDefinitionRevisionModel, Field(description="The body content of the request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> CreateOrderDefinitionRevisionResult:
        """Creates a new revision for an existing order definition.


        :param definition_id: The id of the definition this revision should belong to (required)
        :type definition_id: str
        :param create_order_definition_revision_model: The body content of the request (required)
        :type create_order_definition_revision_model: CreateOrderDefinitionRevisionModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._order_definition_definition_id_revision_post_serialize(
            definition_id=definition_id,
            create_order_definition_revision_model=create_order_definition_revision_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateOrderDefinitionRevisionResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def order_definition_definition_id_revision_post_with_http_info(
        self,
        definition_id: Annotated[StrictStr, Field(description="The id of the definition this revision should belong to")],
        create_order_definition_revision_model: Annotated[CreateOrderDefinitionRevisionModel, Field(description="The body content of the request")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateOrderDefinitionRevisionResult]:
        """Creates a new revision for an existing order definition.
    ...
    @validate_call
    def order_definition_definition_id_revision_post_without_preload_content(
        self,
        definition_id: Annotated[StrictStr, Field(description="The id of the definition this revision should belong to")],
        create_order_definition_revision_model: Annotated[CreateOrderDefinitionRevisionModel, Field(description="The body content of the request")],
        _request_timeout: Union[
    ...
    def _order_definition_definition_id_revision_post_serialize(
        self,
        definition_id,
        create_order_definition_revision_model,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_order_definition_revision_model is not None:
            _body_params = create_order_definition_revision_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/order/definition/{definitionId}/revision',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def order_definition_post(
        self,
        create_order_definition_model: Annotated[CreateOrderDefinitionModel, Field(description="The body content of the request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_order_definition_model: The body content of the request (required)
        :type create_order_definition_model: CreateOrderDefinitionModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._order_definition_post_serialize(
            create_order_definition_model=create_order_definition_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateOrderDefinitionResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def order_definition_post_with_http_info(
        self,
        create_order_definition_model: Annotated[CreateOrderDefinitionModel, Field(description="The body content of the request")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateOrderDefinitionResult]:
        """Creates a new order definition.
    ...
    @validate_call
    def order_definition_post_without_preload_content(
        self,
        create_order_definition_model: Annotated[CreateOrderDefinitionModel, Field(description="The body content of the request")],
        _request_timeout: Union[
            None,
    ...
    def _order_definition_post_serialize(
        self,
        create_order_definition_model,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_order_definition_model is not None:
            _body_params = create_order_definition_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/order/definition',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
