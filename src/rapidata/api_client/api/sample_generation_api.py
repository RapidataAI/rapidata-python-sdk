...
class SampleGenerationApi:
    ...
    def benchmark_sample_generation_sample_generation_id_items_get(
        ...
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort fields. Prefix with - for descending order (e.g. -created_at).")] = None,
        status: Annotated[Optional[AudienceAudienceIdJobsGetJobIdParameter], Field(description="Filter by status.")] = None,
        failure_category: Annotated[Optional[AudienceAudienceIdJobsGetJobIdParameter], Field(description="Filter by failure_category.")] = None,
        ...
        :param status: Filter by status.
        :type status: AudienceAudienceIdJobsGetJobIdParameter
        :param failure_category: Filter by failure_category.
        :type failure_category: AudienceAudienceIdJobsGetJobIdParameter
            ...
            if isinstance(_param_val, dict):
                for _k, _v in _param_val.items():
                    ...
                    if isinstance(_v, list):
                        ...
                        # params: field[in]=a&field[in]=b.
                        for _item in _v:
                            _query_params.append(('failure_category[' + _k + ']', _item))
                    else:
                        _query_params.append(('failure_category[' + _k + ']', _v))
    ...
    def benchmark_sample_generation_sample_generation_id_retry_post(
        self,
        sample_generation_id: Annotated[StrictStr, Field(description="The id of the sample generation request.")],
        retry_sample_generation_endpoint_input: Annotated[Optional[RetrySampleGenerationEndpointInput], Field(description="Optional payload restricting the retry to specific item ids, failure  categories, or both.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sample_generation_id: The id of the sample generation request. (required)
        :type sample_generation_id: str
        :param retry_sample_generation_endpoint_input: Optional payload restricting the retry to specific item ids, failure  categories, or both.
