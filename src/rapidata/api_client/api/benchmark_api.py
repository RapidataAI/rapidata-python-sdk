...
class BenchmarkApi:
    ...
    def benchmark_benchmark_id_get(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetBenchmarkByIdQueryResultPagedResult:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetBenchmarkByIdQueryResultPagedResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def benchmark_benchmark_id_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetBenchmarkByIdQueryResultPagedResult]:
        """Returns a single benchmark by its ID.
    ...
    @validate_call
    def benchmark_benchmark_id_prompts_post(
        self,
        ...
        _param = self._benchmark_benchmark_id_prompts_post_serialize(
            benchmark_id=benchmark_id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def benchmark_benchmark_id_prompts_post_with_http_info(
        self,
        benchmark_id: Annotated[StrictStr, Field(description="The benchmark id.")],
        body: Annotated[Optional[StrictStr], Field(description="The prompt")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def benchmark_benchmark_id_prompts_post_without_preload_content(
        self,
        benchmark_id: Annotated[StrictStr, Field(description="The benchmark id.")],
        body: Annotated[Optional[StrictStr], Field(description="The prompt")] = None,
        _request_timeout: Union[
    ...
    def _benchmark_benchmark_id_prompts_post_serialize(
        self,
        benchmark_id,
        body,
        _request_auth,
