...
class CampaignApi:
    ...
    @validate_call
    def campaign_campaign_id_activate_post(
        self,
        campaign_id: Annotated[StrictStr, Field(description="The identifier of the campaign to activate.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Only campaigns in the Created, Preview, or Analysis state can be activated; any other  state returns 400. A program campaign has no top-level routing id and is therefore not  picked up by the target-group-driven auto-activation, so this endpoint is how it is moved  into the serving set.

        :param campaign_id: The identifier of the campaign to activate. (required)
        ...
        _param = self._campaign_campaign_id_activate_post_serialize(
    ...
    @validate_call
    def campaign_campaign_id_activate_post_with_http_info(
        self,
        campaign_id: Annotated[StrictStr, Field(description="The identifier of the campaign to activate.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def campaign_campaign_id_activate_post_without_preload_content(
        self,
        campaign_id: Annotated[StrictStr, Field(description="The identifier of the campaign to activate.")],
        _request_timeout: Union[
            None,
    ...
    def _campaign_campaign_id_activate_post_serialize(
        self,
        campaign_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/campaign/{campaignId}/activate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
            ...
            if isinstance(_param_val, dict):
                for _k, _v in _param_val.items():
                    ...
                    if isinstance(_v, list):
                        ...
                        # params: field[in]=a&field[in]=b.
                        for _item in _v:
                            _query_params.append(('priority[' + _k + ']', _item))
                    else:
