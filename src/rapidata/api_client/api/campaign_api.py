...
class CampaignApi:
    ...
    def campaign_campaign_id_patch(
        ...
        update_campaign_model: Annotated[Optional[UpdateCampaignModel], Field(description="model containing the updates")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_campaign_model: model containing the updates
    ...
    def campaigns_get(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> PagedResultCampaignQueryResult:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PagedResultCampaignQueryResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def campaigns_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PagedResultCampaignQueryResult]:
        """Queries orders based on a filter, page, and sort criteria.
