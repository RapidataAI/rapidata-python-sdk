...
class ExternalAudienceApi:
    ...
    @validate_call
    def campaign_external_audiences_get(
        self,
        ...
        count: Annotated[Optional[CampaignsGetIdParameter], Field(description="Filter by count.")] = None,
        ...
        """campaign_external_audiences_get
        ...
        :type count: CampaignsGetIdParameter
        ...
        _param = self._campaign_external_audiences_get_serialize(
            page=page,
            page_size=page_size,
            sort=sort,
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QueryExternalAudiencesEndpointPagedResultOfOutput",
    ...
    @validate_call
    def campaign_external_audiences_get_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The 1-based page index.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of items per page.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort fields. Prefix with - for descending order (e.g. -created_at).")] = None,
    ...
    @validate_call
    def campaign_external_audiences_get_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The 1-based page index.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of items per page.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort fields. Prefix with - for descending order (e.g. -created_at).")] = None,
    ...
    def _campaign_external_audiences_get_serialize(
        self,
        page,
        page_size,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/campaign/external-audiences',
    ...
    @validate_call
    def campaign_external_audiences_sync_post(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """campaign_external_audiences_sync_post
        ...
        _param = self._campaign_external_audiences_sync_post_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def campaign_external_audiences_sync_post_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def campaign_external_audiences_sync_post_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _campaign_external_audiences_sync_post_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/campaign/external-audiences/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
