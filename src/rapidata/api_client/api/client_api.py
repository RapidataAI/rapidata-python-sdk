...
class ClientApi:
    ...
    def client_create_client_post(
        ...
        _param = self._client_create_client_post_serialize(
    ...
    @validate_call
    def client_create_client_post_with_http_info(
        self,
        create_client_model: Annotated[Optional[CreateClientModel], Field(description="The model for creating a new client.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def client_create_client_post_without_preload_content(
        self,
        create_client_model: Annotated[Optional[CreateClientModel], Field(description="The model for creating a new client.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _client_create_client_post_serialize(
        self,
        create_client_model,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Client/CreateClient',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
