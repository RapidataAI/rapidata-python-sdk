...
class RankingFlowApi:
    ...
    @validate_call
    def flow_ranking_flow_id_patch(
        self,
        ...
        _param = self._flow_ranking_flow_id_patch_serialize(
            flow_id=flow_id,
    ...
    @validate_call
    def flow_ranking_flow_id_patch_with_http_info(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the ranking flow to update.")],
        update_config_endpoint_input: Annotated[UpdateConfigEndpointInput, Field(description="The configuration fields to update.")],
        _request_timeout: Union[
    ...
    @validate_call
    def flow_ranking_flow_id_patch_without_preload_content(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the ranking flow to update.")],
        update_config_endpoint_input: Annotated[UpdateConfigEndpointInput, Field(description="The configuration fields to update.")],
        _request_timeout: Union[
    ...
    def _flow_ranking_flow_id_patch_serialize(
        self,
        flow_id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/flow/ranking/{flowId}',
    ...
    def flow_ranking_post(
        ...
        _param = self._flow_ranking_post_serialize(
            create_flow_endpoint_input=create_flow_endpoint_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _flow_ranking_post_serialize(
        self,
        create_flow_endpoint_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_flow_endpoint_input is not None:
            _body_params = create_flow_endpoint_input
