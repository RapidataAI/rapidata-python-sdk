...
class FlowApi:
    ...
    def flow_flow_id_delete(
        ...
        _param = self._flow_flow_id_delete_serialize(
            flow_id=flow_id,
    ...
    def _flow_flow_id_delete_serialize(
        self,
        flow_id,
        _request_auth,
        _content_type,
    ...
    def flow_flow_id_get(
        ...
        _param = self._flow_flow_id_get_serialize(
            flow_id=flow_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _flow_flow_id_get_serialize(
        self,
        flow_id,
        _request_auth,
        _content_type,
    ...
    def flow_get(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QueryFlowsEndpointPagedResultOfOutput",
            '400': "ValidationProblemDetails",
            '401': None,
            '403': None,
        }
    ...
    @validate_call
    def flow_ranking_flow_id_completion_time_histogram_get(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (inclusive).")] = None,
        bucket_count: Annotated[Optional[StrictInt], Field(description="Number of histogram buckets (default 10, max 100).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param flow_id: The ID of the flow. (required)
        :type flow_id: str
        :param var_from: Optional start of the date range filter (inclusive).
        :type var_from: datetime
        :param to: Optional end of the date range filter (inclusive).
        :type to: datetime
        :param bucket_count: Number of histogram buckets (default 10, max 100).
        ...
        _param = self._flow_ranking_flow_id_completion_time_histogram_get_serialize(
            flow_id=flow_id,
            var_from=var_from,
            to=to,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCompletionTimeHistogramEndpointOutput",
            '400': "ValidationProblemDetails",
            '401': None,
            '403': None,
        }
    ...
    @validate_call
    def flow_ranking_flow_id_completion_time_histogram_get_with_http_info(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (inclusive).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCompletionTimeHistogramEndpointOutput]:
        """Returns the distribution of completion durations (in seconds) per completed flow item.
    ...
    @validate_call
    def flow_ranking_flow_id_completion_time_histogram_get_without_preload_content(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (inclusive).")] = None,
    ...
    def _flow_ranking_flow_id_completion_time_histogram_get_serialize(
        self,
        flow_id,
        var_from,
        to,
        ...
        if bucket_count is not None:
            ...
            _query_params.append(('bucketCount', bucket_count))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/flow/ranking/{flowId}/completion-time-histogram',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def flow_ranking_flow_id_flow_item_creation_timeseries_get(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (exclusive).")] = None,
        datapoints: Annotated[Optional[StrictInt], Field(description="Number of time buckets (default 100, max 1000).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param var_from: Optional start of the date range filter (inclusive).
        :type var_from: datetime
        :param to: Optional end of the date range filter (exclusive).
        :type to: datetime
        :param datapoints: Number of time buckets (default 100, max 1000).
        :type datapoints: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._flow_ranking_flow_id_flow_item_creation_timeseries_get_serialize(
            flow_id=flow_id,
            var_from=var_from,
            to=to,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetFlowItemCreationTimeseriesEndpointOutput",
            '400': "ValidationProblemDetails",
            '401': None,
            '403': None,
        }
    ...
    @validate_call
    def flow_ranking_flow_id_flow_item_creation_timeseries_get_with_http_info(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (exclusive).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFlowItemCreationTimeseriesEndpointOutput]:
        """Returns flow item creation counts bucketed over time.
    ...
    @validate_call
    def flow_ranking_flow_id_flow_item_creation_timeseries_get_without_preload_content(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (exclusive).")] = None,
    ...
    def _flow_ranking_flow_id_flow_item_creation_timeseries_get_serialize(
        self,
        flow_id,
        var_from,
        to,
        ...
        if datapoints is not None:
            ...
            _query_params.append(('datapoints', datapoints))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/flow/ranking/{flowId}/flow-item-creation-timeseries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def flow_ranking_flow_id_response_count_histogram_get(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (inclusive).")] = None,
        ...
        _param = self._flow_ranking_flow_id_response_count_histogram_get_serialize(
            flow_id=flow_id,
            var_from=var_from,
            to=to,
            bucket_count=bucket_count,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetResponseCountHistogramEndpointOutput",
            '400': "ValidationProblemDetails",
            '401': None,
            '403': None,
        }
    ...
    @validate_call
    def flow_ranking_flow_id_response_count_histogram_get_with_http_info(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (inclusive).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetResponseCountHistogramEndpointOutput]:
        """Returns the distribution of total votes per completed flow item.
    ...
    @validate_call
    def flow_ranking_flow_id_response_count_histogram_get_without_preload_content(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (inclusive).")] = None,
    ...
    def _flow_ranking_flow_id_response_count_histogram_get_serialize(
        self,
        flow_id,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/flow/ranking/{flowId}/response-count-histogram',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def flow_ranking_flow_id_response_count_timeseries_get(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (exclusive).")] = None,
        ...
        _param = self._flow_ranking_flow_id_response_count_timeseries_get_serialize(
            flow_id=flow_id,
            var_from=var_from,
            to=to,
            datapoints=datapoints,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetResponseCountTimeseriesEndpointOutput",
            '400': "ValidationProblemDetails",
            '401': None,
            '403': None,
        }
    ...
    @validate_call
    def flow_ranking_flow_id_response_count_timeseries_get_with_http_info(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (exclusive).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetResponseCountTimeseriesEndpointOutput]:
        """Returns average response counts bucketed over time for completed flow items.
    ...
    @validate_call
    def flow_ranking_flow_id_response_count_timeseries_get_without_preload_content(
        self,
        flow_id: Annotated[StrictStr, Field(description="The ID of the flow.")],
        var_from: Annotated[Optional[datetime], Field(description="Optional start of the date range filter (inclusive).")] = None,
        to: Annotated[Optional[datetime], Field(description="Optional end of the date range filter (exclusive).")] = None,
    ...
    def _flow_ranking_flow_id_response_count_timeseries_get_serialize(
        self,
        flow_id,
        var_from,
        to,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/flow/ranking/{flowId}/response-count-timeseries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
