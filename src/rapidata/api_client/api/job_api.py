...
class JobApi:
    ...
    def job_job_id_shares_post(
        ...
        The email must belong to an existing account; an unknown email returns 400 Bad Request.  Granting editor access implies viewing. Re-sharing at the same level is idempotent.
