...
from rapidata.api_client.models.query_shared_jobs_endpoint_paged_result_of_output import QuerySharedJobsEndpointPagedResultOfOutput
...
class JobApi:
    ...
    def jobs_shared_get(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> QuerySharedJobsEndpointPagedResultOfOutput:
        """Queries the jobs another organization has shared with the caller.
        ...
        _param = self._jobs_shared_get_serialize(
            page=page,
            page_size=page_size,
            sort=sort,
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "QuerySharedJobsEndpointPagedResultOfOutput",
            '400': "ValidationProblemDetails",
            '401': None,
            '403': None,
        }
    ...
    @validate_call
    def jobs_shared_get_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The 1-based page index.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of items per page.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort fields. Prefix with - for descending order (e.g. -created_at).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QuerySharedJobsEndpointPagedResultOfOutput]:
        """Queries the jobs another organization has shared with the caller.
    ...
    @validate_call
    def jobs_shared_get_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The 1-based page index.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="The number of items per page.")] = None,
        sort: Annotated[Optional[List[StrictStr]], Field(description="Sort fields. Prefix with - for descending order (e.g. -created_at).")] = None,
    ...
    def _jobs_shared_get_serialize(
        self,
        page,
        page_size,
        sort,
