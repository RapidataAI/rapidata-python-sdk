...
class CustomerRapidApi:
    ...
    def rapids_flagged_get(
        ...
        completion_date: Annotated[Optional[AudienceAudienceIdJobsGetJobIdParameter], Field(description="Filter by completion_date.")] = None,
        logic: Annotated[Optional[StrictStr], Field(description="How to combine the field filters: \"and\" (default) requires every filter to match, \"or\" requires any of them to match.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param completion_date: Filter by completion_date.
        :type completion_date: AudienceAudienceIdJobsGetJobIdParameter
        :param logic: How to combine the field filters: \"and\" (default) requires every filter to match, \"or\" requires any of them to match.
        :type logic: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
            ...
            if isinstance(_param_val, dict):
                for _k, _v in _param_val.items():
                    ...
                    if isinstance(_v, list):
                        ...
                        # params: field[in]=a&field[in]=b.
                        for _item in _v:
                            _query_params.append(('completion_date[' + _k + ']', _item))
                    else:
                        _query_params.append(('completion_date[' + _k + ']', _v))
        if logic is not None:
