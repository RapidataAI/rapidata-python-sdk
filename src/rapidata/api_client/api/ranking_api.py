...
from typing_extensions import Annotated
from rapidata.api_client.models.get_ranking_workflow_results_endpoint_output import GetRankingWorkflowResultsEndpointOutput
...
class RankingApi:
    ...
    def workflow_compare_workflow_id_results_get(
        ...
        """Gets the result overview for a ranking workflow.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetRankingWorkflowResultsEndpointOutput",
    ...
    def workflow_compare_workflow_id_results_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetRankingWorkflowResultsEndpointOutput]:
        """Gets the result overview for a ranking workflow.
