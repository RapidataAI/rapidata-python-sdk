...
- API version: 2026.09.20.1313-5425063
...
*ExperimentApi* | [**campaign_experiments_experiment_key_get**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_experiment_key_get) | **GET** /campaign/experiments/{experimentKey} | Returns the experiment with the given key.
*ExperimentApi* | [**campaign_experiments_experiment_key_patch**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_experiment_key_patch) | **PATCH** /campaign/experiments/{experimentKey} | Updates the provided fields of an experiment and returns the full updated document.
*ExperimentApi* | [**campaign_experiments_experiment_key_state_post**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_experiment_key_state_post) | **POST** /campaign/experiments/{experimentKey}/state | Applies a lifecycle transition to an experiment and returns the full updated document.
