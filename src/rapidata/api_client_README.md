...
- API version: 2026.07.30.0813-e344d2e
...
*SettingsApi* | [**billing_customer_customer_id_settings_post**](rapidata/api_client/docs/SettingsApi.md#billing_customer_customer_id_settings_post) | **POST** /billing/customer/{customerId}/settings | Creates a billing setting for a customer.
*SettingsApi* | [**billing_customer_customer_id_settings_setting_id_delete**](rapidata/api_client/docs/SettingsApi.md#billing_customer_customer_id_settings_setting_id_delete) | **DELETE** /billing/customer/{customerId}/settings/{settingId} | Deletes a customer billing setting.
