...
- API version: 2026.09.19.1603-ff82c3c
...
*SimpleFlowItemApi* | [**flow_simple_flow_id_item_post**](rapidata/api_client/docs/SimpleFlowItemApi.md#flow_simple_flow_id_item_post) | **POST** /flow/simple/{flowId}/item | Creates a flow item that labels every datapoint of the dataset with the flow&#39;s blueprint; the dataset holds between 1 and the flow&#39;s MaxDatapointsPerItem datapoints.
*SimpleFlowItemApi* | [**flow_simple_item_flow_item_id_results_get**](rapidata/api_client/docs/SimpleFlowItemApi.md#flow_simple_item_flow_item_id_results_get) | **GET** /flow/simple/item/{flowItemId}/results | Returns the category distribution and majority per datapoint of a completed simple flow item.
