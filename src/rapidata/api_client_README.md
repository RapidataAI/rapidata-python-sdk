...
- API version: 2026.08.12.1010-860c8c8
...
*BenchmarkApi* | [**benchmark_benchmark_id_images_query_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_images_query_get) | **GET** /benchmark/{benchmarkId}/images/query | Queries the per-image ratings of a benchmark — a page of prompts, each with its ranked images  and the pairwise win matrix over them, in the same pandas-split shape as the standings matrix.
...
*BillingApi* | [**billing_organization_organization_id_settings_post**](rapidata/api_client/docs/BillingApi.md#billing_organization_organization_id_settings_post) | **POST** /billing/organization/{organizationId}/settings | Creates a billing setting for a customer.
*BillingApi* | [**billing_organization_organization_id_settings_setting_id_delete**](rapidata/api_client/docs/BillingApi.md#billing_organization_organization_id_settings_setting_id_delete) | **DELETE** /billing/organization/{organizationId}/settings/{settingId} | Deletes a customer billing setting.
...
*SettingsApi* | [**billing_organization_organization_id_settings_post**](rapidata/api_client/docs/SettingsApi.md#billing_organization_organization_id_settings_post) | **POST** /billing/organization/{organizationId}/settings | Creates a billing setting for a customer.
*SettingsApi* | [**billing_organization_organization_id_settings_setting_id_delete**](rapidata/api_client/docs/SettingsApi.md#billing_organization_organization_id_settings_setting_id_delete) | **DELETE** /billing/organization/{organizationId}/settings/{settingId} | Deletes a customer billing setting.
...
## Documentation For Models
 ...
 - [QueryImagesByBenchmarkEndpointOutput](rapidata/api_client/docs/QueryImagesByBenchmarkEndpointOutput.md)
 - [QueryImagesByBenchmarkEndpointOutputImage](rapidata/api_client/docs/QueryImagesByBenchmarkEndpointOutputImage.md)
 - [QueryImagesByBenchmarkEndpointOutputPrompt](rapidata/api_client/docs/QueryImagesByBenchmarkEndpointOutputPrompt.md)
