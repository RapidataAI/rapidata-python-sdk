...
- API version: 2026.09.10.1512-ad901d4
...
*FaucetApi* | [**participant_participant_id_faucet_put**](rapidata/api_client/docs/FaucetApi.md#participant_participant_id_faucet_put) | **PUT** /participant/{participantId}/faucet | Sets the faucet used to auto-generate samples for a participant.
