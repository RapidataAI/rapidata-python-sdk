...
- API version: 2026.09.25.1743-4cba489
...
*AudienceApi* | [**audience_audience_id_shares_customer_id_delete**](rapidata/api_client/docs/AudienceApi.md#audience_audience_id_shares_customer_id_delete) | **DELETE** /audience/{audienceId}/shares/{customerId} | Removes a customer&#39;s viewer and editor access to an audience.
*AudienceApi* | [**audience_audience_id_shares_get**](rapidata/api_client/docs/AudienceApi.md#audience_audience_id_shares_get) | **GET** /audience/{audienceId}/shares | Returns each customer an audience is shared with, together with their access level.
*AudienceApi* | [**audience_audience_id_shares_organizations_get**](rapidata/api_client/docs/AudienceApi.md#audience_audience_id_shares_organizations_get) | **GET** /audience/{audienceId}/shares/organizations | Returns each organization an audience is shared with, together with its access level.
*AudienceApi* | [**audience_audience_id_shares_organizations_organization_id_delete**](rapidata/api_client/docs/AudienceApi.md#audience_audience_id_shares_organizations_organization_id_delete) | **DELETE** /audience/{audienceId}/shares/organizations/{organizationId} | Removes an organization&#39;s viewer and editor access to an audience.
*AudienceApi* | [**audience_audience_id_shares_organizations_post**](rapidata/api_client/docs/AudienceApi.md#audience_audience_id_shares_organizations_post) | **POST** /audience/{audienceId}/shares/organizations | Grants every member of an organization viewer or editor access to an audience.
*AudienceApi* | [**audience_audience_id_shares_post**](rapidata/api_client/docs/AudienceApi.md#audience_audience_id_shares_post) | **POST** /audience/{audienceId}/shares | Grants a customer viewer or editor access to an audience by their email.
...
*AudienceApi* | [**audiences_get**](rapidata/api_client/docs/AudienceApi.md#audiences_get) | **GET** /audiences | Queries the audiences visible to the caller: owned, shared with them, or both.
...
*BenchmarkApi* | [**benchmark_benchmark_id_huggingface_sync_attempts_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_huggingface_sync_attempts_get) | **GET** /benchmark/{benchmarkId}/huggingface-sync/attempts | Queries the benchmark&#39;s HuggingFace sync attempts (empty when it has never been synced).
*BenchmarkApi* | [**benchmark_benchmark_id_huggingface_sync_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_huggingface_sync_get) | **GET** /benchmark/{benchmarkId}/huggingface-sync | Returns the HuggingFace sync status of the benchmark.
*BenchmarkApi* | [**benchmark_benchmark_id_huggingface_sync_post**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_huggingface_sync_post) | **POST** /benchmark/{benchmarkId}/huggingface-sync | Starts a HuggingFace sync of the benchmark and returns its current sync status.
...
*BenchmarkApi* | [**benchmark_benchmark_id_matchup_breakdown_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_matchup_breakdown_get) | **GET** /benchmark/{benchmarkId}/matchup-breakdown | Returns a page of the requested confidence zone of an A-vs-B matchup — the prompts A clearly  wins, the coin flips, or the prompts B clearly wins.
*BenchmarkApi* | [**benchmark_benchmark_id_matchups_query_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_matchups_query_get) | **GET** /benchmark/{benchmarkId}/matchups/query | Queries a benchmark&#39;s image matchups — a page of compared image pairs with how the responses  split between them.
*BenchmarkApi* | [**benchmark_benchmark_id_matrix_query_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_matrix_query_get) | **GET** /benchmark/{benchmarkId}/matrix/query | Queries the win matrix of a benchmark.
...
*BenchmarkApi* | [**benchmark_benchmark_id_prompt_embedding_map_delete**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_prompt_embedding_map_delete) | **DELETE** /benchmark/{benchmarkId}/prompt-embedding-map | Deletes the benchmark&#39;s prompt embedding map.
*BenchmarkApi* | [**benchmark_benchmark_id_prompt_embedding_map_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_prompt_embedding_map_get) | **GET** /benchmark/{benchmarkId}/prompt-embedding-map | Returns the benchmark&#39;s prompt embedding map.
*BenchmarkApi* | [**benchmark_benchmark_id_prompt_embedding_map_post**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_prompt_embedding_map_post) | **POST** /benchmark/{benchmarkId}/prompt-embedding-map | Starts an asynchronous computation of the benchmark&#39;s prompt embedding map.
*BenchmarkApi* | [**benchmark_benchmark_id_prompt_embedding_map_status_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_prompt_embedding_map_status_get) | **GET** /benchmark/{benchmarkId}/prompt-embedding-map/status | Returns the state of the benchmark&#39;s most recent prompt embedding map computation.
...
*BenchmarkApi* | [**benchmark_benchmark_id_prompt_ratings_query_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_prompt_ratings_query_get) | **GET** /benchmark/{benchmarkId}/prompt-ratings/query | Queries a benchmark&#39;s prompt ratings — a page of prompts, each with its ranked entries and the  pairwise win matrix over them.
*BenchmarkApi* | [**benchmark_benchmark_id_prompt_structure_put**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_prompt_structure_put) | **PUT** /benchmark/{benchmarkId}/prompt-structure | Replaces a benchmark&#39;s prompt structure with the submitted one.
...
*BenchmarkApi* | [**benchmark_benchmark_id_runs_custom_post**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_runs_custom_post) | **POST** /benchmark/{benchmarkId}/runs/custom | Creates one run per leaderboard of the benchmark, each evaluating the same explicit list of  matchup configurations.
...
*BenchmarkApi* | [**benchmark_benchmark_id_sample_generation_preview_post**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_sample_generation_preview_post) | **POST** /benchmark/{benchmarkId}/sample-generation/preview | Reports how many samples the given configuration would generate, and for which participants.
...
*BenchmarkApi* | [**benchmark_benchmark_id_standings_by_tag_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_benchmark_id_standings_by_tag_get) | **GET** /benchmark/{benchmarkId}/standings/by-tag | Returns the standings over the whole filtered set alongside the standings recomputed for each  tag on the benchmark.
...
*BenchmarkApi* | [**benchmark_combined_standings_query_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_combined_standings_query_get) | **GET** /benchmark/combined-standings/query | Queries the combined standings of multiple benchmarks.
*BenchmarkApi* | [**benchmark_post**](rapidata/api_client/docs/BenchmarkApi.md#benchmark_post) | **POST** /benchmark | Creates a benchmark.
*BenchmarkApi* | [**benchmarks_get**](rapidata/api_client/docs/BenchmarkApi.md#benchmarks_get) | **GET** /benchmarks | Queries all benchmarks of the current user&#39;s organization.
...
*BillingApi* | [**billing_manual_charge_manual_charge_id_delete**](rapidata/api_client/docs/BillingApi.md#billing_manual_charge_manual_charge_id_delete) | **DELETE** /billing/manual-charge/{manualChargeId} | Deletes a manual charge from its billing period.
...
*BillingApi* | [**billing_organization_organization_id_settings_post**](rapidata/api_client/docs/BillingApi.md#billing_organization_organization_id_settings_post) | **POST** /billing/organization/{organizationId}/settings | Creates a billing setting for an organization.
*BillingApi* | [**billing_organization_organization_id_settings_setting_id_delete**](rapidata/api_client/docs/BillingApi.md#billing_organization_organization_id_settings_setting_id_delete) | **DELETE** /billing/organization/{organizationId}/settings/{settingId} | Deletes an organization billing setting.
*BillingApi* | [**billing_organization_organization_id_volume_discounts_get**](rapidata/api_client/docs/BillingApi.md#billing_organization_organization_id_volume_discounts_get) | **GET** /billing/organization/{organizationId}/volume-discounts | Gets an organization&#39;s current volume discount brackets.
*BillingApi* | [**billing_organization_organization_id_volume_discounts_put**](rapidata/api_client/docs/BillingApi.md#billing_organization_organization_id_volume_discounts_put) | **PUT** /billing/organization/{organizationId}/volume-discounts | Replaces an organization&#39;s whole volume discount bracket set.
*BillingApi* | [**billing_outstanding_get**](rapidata/api_client/docs/BillingApi.md#billing_outstanding_get) | **GET** /billing/outstanding | Gets the total amount the organization currently owes, broken down by unpaid invoices and  periods awaiting an invoice.
...
*BillingApi* | [**billing_period_billing_period_id_close_post**](rapidata/api_client/docs/BillingApi.md#billing_period_billing_period_id_close_post) | **POST** /billing-period/{billingPeriodId}/close | Closes a billing period, writing off whatever it would still have invoiced.
...
*BillingApi* | [**billing_period_billing_period_id_resettle_post**](rapidata/api_client/docs/BillingApi.md#billing_period_billing_period_id_resettle_post) | **POST** /billing-period/{billingPeriodId}/resettle | Recomputes a billing period&#39;s invoiceable amount and voucher coverage, and returns the result.
...
*BillingApi* | [**billing_periods_close_bulk_bulk_close_id_get**](rapidata/api_client/docs/BillingApi.md#billing_periods_close_bulk_bulk_close_id_get) | **GET** /billing-periods/close-bulk/{bulkCloseId} | Returns how far a bulk close has got, what it has written off so far, and one verdict per period  it has reached.
*BillingApi* | [**billing_periods_close_bulk_post**](rapidata/api_client/docs/BillingApi.md#billing_periods_close_bulk_post) | **POST** /billing-periods/close-bulk | Starts closing every billing period awaiting review that ended before a date, optionally limited  to those worth no more than a given amount.
...
*BillingAccountApi* | [**billing_organization_organization_id_credit_line_put**](rapidata/api_client/docs/BillingAccountApi.md#billing_organization_organization_id_credit_line_put) | **PUT** /billing/organization/{organizationId}/credit-line | Sets the spend limit for an organization.
*BillingAccountApi* | [**billing_organization_organization_id_minimum_spend_commitment_put**](rapidata/api_client/docs/BillingAccountApi.md#billing_organization_organization_id_minimum_spend_commitment_put) | **PUT** /billing/organization/{organizationId}/minimum-spend-commitment | Sets the minimum spend commitment for a customer.
*BillingAccountApi* | [**billing_organization_organization_id_platform_fee_put**](rapidata/api_client/docs/BillingAccountApi.md#billing_organization_organization_id_platform_fee_put) | **PUT** /billing/organization/{organizationId}/platform-fee | Sets the platform fee for a customer.
...
*CampaignApi* | [**campaign_campaign_id_activate_post**](rapidata/api_client/docs/CampaignApi.md#campaign_campaign_id_activate_post) | **POST** /campaign/{campaignId}/activate | Activates the specified campaign.
...
*CustomerApi* | [**customers_customer_id_delete**](rapidata/api_client/docs/CustomerApi.md#customers_customer_id_delete) | **DELETE** /customers/{customerId} | Deletes the account: it can no longer sign in, stops receiving email, and leaves every  organization it belongs to.
...
*ExperimentApi* | [**campaign_experiments_experiment_id_get**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_experiment_id_get) | **GET** /campaign/experiments/{experimentId} | Returns the experiment with the given key.
*ExperimentApi* | [**campaign_experiments_experiment_id_patch**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_experiment_id_patch) | **PATCH** /campaign/experiments/{experimentId} | Updates the provided fields of an experiment and returns the full updated document.
*ExperimentApi* | [**campaign_experiments_experiment_id_state_post**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_experiment_id_state_post) | **POST** /campaign/experiments/{experimentId}/state | Applies a lifecycle transition to an experiment and returns the full updated document.
*ExperimentApi* | [**campaign_experiments_get**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_get) | **GET** /campaign/experiments | Returns all experiments, optionally restricted to one state.
*ExperimentApi* | [**campaign_experiments_post**](rapidata/api_client/docs/ExperimentApi.md#campaign_experiments_post) | **POST** /campaign/experiments | Creates an experiment in the draft state and returns the full document.
*ExternalAppsApi* | [**authorization_relations_external_app_delete**](rapidata/api_client/docs/ExternalAppsApi.md#authorization_relations_external_app_delete) | **DELETE** /authorization/relations/external-app | Revokes an external app relation from a customer.
*ExternalAppsApi* | [**authorization_relations_external_app_get**](rapidata/api_client/docs/ExternalAppsApi.md#authorization_relations_external_app_get) | **GET** /authorization/relations/external-app | Lists the customers holding relations on one app, one cursor page at a time.
*ExternalAppsApi* | [**authorization_relations_external_app_put**](rapidata/api_client/docs/ExternalAppsApi.md#authorization_relations_external_app_put) | **PUT** /authorization/relations/external-app | Grants an external app relation to a customer.
...
*ExternalServicePricesApi* | [**billing_external_service_prices_post**](rapidata/api_client/docs/ExternalServicePricesApi.md#billing_external_service_prices_post) | **POST** /billing/external-service-prices | Creates a rate-card price for an external service.
...
*FaucetApi* | [**participant_participant_id_faucet_delete**](rapidata/api_client/docs/FaucetApi.md#participant_participant_id_faucet_delete) | **DELETE** /participant/{participantId}/faucet | Removes the faucet configuration from a participant.
...
*HuggingFaceSyncApi* | [**benchmark_benchmark_id_huggingface_sync_attempts_get**](rapidata/api_client/docs/HuggingFaceSyncApi.md#benchmark_benchmark_id_huggingface_sync_attempts_get) | **GET** /benchmark/{benchmarkId}/huggingface-sync/attempts | Queries the benchmark&#39;s HuggingFace sync attempts (empty when it has never been synced).
*HuggingFaceSyncApi* | [**benchmark_benchmark_id_huggingface_sync_get**](rapidata/api_client/docs/HuggingFaceSyncApi.md#benchmark_benchmark_id_huggingface_sync_get) | **GET** /benchmark/{benchmarkId}/huggingface-sync | Returns the HuggingFace sync status of the benchmark.
*HuggingFaceSyncApi* | [**benchmark_benchmark_id_huggingface_sync_post**](rapidata/api_client/docs/HuggingFaceSyncApi.md#benchmark_benchmark_id_huggingface_sync_post) | **POST** /benchmark/{benchmarkId}/huggingface-sync | Starts a HuggingFace sync of the benchmark and returns its current sync status.
...
*InvoiceApi* | [**invoice_invoice_id_delete**](rapidata/api_client/docs/InvoiceApi.md#invoice_invoice_id_delete) | **DELETE** /invoice/{invoiceId} | Deletes a draft invoice, discarding it completely.
...
*JobApi* | [**job_definition_definition_id_clone_post**](rapidata/api_client/docs/JobApi.md#job_definition_definition_id_clone_post) | **POST** /job/definition/{definitionId}/clone | Clones a job definition into a new, private definition owned by the caller.
...
*JobApi* | [**job_definition_definition_id_share_patch**](rapidata/api_client/docs/JobApi.md#job_definition_definition_id_share_patch) | **PATCH** /job/definition/{definitionId}/share | Marks or unmarks a job definition as a public template that other users can discover and run.
...
*JobApi* | [**job_job_id_ab_summary_get**](rapidata/api_client/docs/JobApi.md#job_job_id_ab_summary_get) | **GET** /job/{jobId}/ab-summary | Gets the A/B winner summary for a job&#39;s comparison labelling.
...
*JobApi* | [**job_job_id_datapoints_get**](rapidata/api_client/docs/JobApi.md#job_job_id_datapoints_get) | **GET** /job/{jobId}/datapoints | Gets the datapoints of the dataset backing a job.
...
*JobApi* | [**job_job_id_progress_get**](rapidata/api_client/docs/JobApi.md#job_job_id_progress_get) | **GET** /job/{jobId}/progress | Gets the labelling progress for a job.
...
*JobApi* | [**job_job_id_responses_get**](rapidata/api_client/docs/JobApi.md#job_job_id_responses_get) | **GET** /job/{jobId}/responses | Gets the most recent responses for a job.
*JobApi* | [**job_job_id_results_get**](rapidata/api_client/docs/JobApi.md#job_job_id_results_get) | **GET** /job/{jobId}/results | Gets the results grid for a job.
*JobApi* | [**job_job_id_results_groups_group_id_get**](rapidata/api_client/docs/JobApi.md#job_job_id_results_groups_group_id_get) | **GET** /job/{jobId}/results/groups/{groupId} | Gets one group&#39;s Elo-ranked datapoints within a grouped-ranking job.
*JobApi* | [**job_job_id_results_rapid_id_navigation_get**](rapidata/api_client/docs/JobApi.md#job_job_id_results_rapid_id_navigation_get) | **GET** /job/{jobId}/results/{rapidId}/navigation | Gets the anchor rapid plus its neighbours within the job&#39;s filtered results.
...
*JobApi* | [**job_job_id_shares_customer_id_delete**](rapidata/api_client/docs/JobApi.md#job_job_id_shares_customer_id_delete) | **DELETE** /job/{jobId}/shares/{customerId} | Removes a customer&#39;s viewer and editor access to a job.
*JobApi* | [**job_job_id_shares_get**](rapidata/api_client/docs/JobApi.md#job_job_id_shares_get) | **GET** /job/{jobId}/shares | Returns each customer a job is shared with, together with their access level.
*JobApi* | [**job_job_id_shares_organizations_get**](rapidata/api_client/docs/JobApi.md#job_job_id_shares_organizations_get) | **GET** /job/{jobId}/shares/organizations | Returns each organization a job is shared with, together with its access level.
*JobApi* | [**job_job_id_shares_organizations_organization_id_delete**](rapidata/api_client/docs/JobApi.md#job_job_id_shares_organizations_organization_id_delete) | **DELETE** /job/{jobId}/shares/organizations/{organizationId} | Removes an organization&#39;s viewer and editor access to a job.
*JobApi* | [**job_job_id_shares_organizations_post**](rapidata/api_client/docs/JobApi.md#job_job_id_shares_organizations_post) | **POST** /job/{jobId}/shares/organizations | Grants every member of an organization viewer or editor access to a job.
*JobApi* | [**job_job_id_shares_post**](rapidata/api_client/docs/JobApi.md#job_job_id_shares_post) | **POST** /job/{jobId}/shares | Grants a customer viewer or editor access to a job by their email.
*JobApi* | [**job_job_id_visibility_patch**](rapidata/api_client/docs/JobApi.md#job_job_id_visibility_patch) | **PATCH** /job/{jobId}/visibility | Marks or unmarks a job as public so its results are viewable via a link.
...
*JobApi* | [**jobs_get**](rapidata/api_client/docs/JobApi.md#jobs_get) | **GET** /jobs | Queries jobs visible to the caller: owned, shared with them, or both.
...
*LeaderboardApi* | [**leaderboard_leaderboard_id_rebalance_post**](rapidata/api_client/docs/LeaderboardApi.md#leaderboard_leaderboard_id_rebalance_post) | **POST** /leaderboard/{leaderboardId}/rebalance | Rebalances a leaderboard by adding responses for the given participants.
*LeaderboardApi* | [**leaderboard_leaderboard_id_runs_custom_post**](rapidata/api_client/docs/LeaderboardApi.md#leaderboard_leaderboard_id_runs_custom_post) | **POST** /leaderboard/{leaderboardId}/runs/custom | Creates a run that evaluates an explicit list of matchup configurations, each with its own  response count.
...
*LeaderboardApi* | [**leaderboard_leaderboard_id_standings_query_get**](rapidata/api_client/docs/LeaderboardApi.md#leaderboard_leaderboard_id_standings_query_get) | **GET** /leaderboard/{leaderboardId}/standings/query | Queries the standings of a leaderboard.
...
*LeaderboardApi* | [**leaderboards_get**](rapidata/api_client/docs/LeaderboardApi.md#leaderboards_get) | **GET** /leaderboards | Queries all leaderboards accessible to the current user&#39;s organization.
...
*OrganizationApi* | [**organizations_invitations_get**](rapidata/api_client/docs/OrganizationApi.md#organizations_invitations_get) | **GET** /organizations/invitations | Returns the pending, not-yet-expired invitations issued to the caller&#39;s email address.
*OrganizationApi* | [**organizations_invitations_invitation_id_accept_post**](rapidata/api_client/docs/OrganizationApi.md#organizations_invitations_invitation_id_accept_post) | **POST** /organizations/invitations/{invitationId}/accept | Accepts the invitation identified by invitationId and sets the joined  organization as the caller&#39;s active one.
*OrganizationApi* | [**organizations_invitations_invitation_id_reject_post**](rapidata/api_client/docs/OrganizationApi.md#organizations_invitations_invitation_id_reject_post) | **POST** /organizations/invitations/{invitationId}/reject | Declines the invitation identified by invitationId. No membership is  created.
*OrganizationApi* | [**organizations_organization_id_delete**](rapidata/api_client/docs/OrganizationApi.md#organizations_organization_id_delete) | **DELETE** /organizations/{organizationId} | Deletes the organization and everything it owns across the platform.
...
*OrganizationApi* | [**organizations_organization_id_members_customer_id_role_put**](rapidata/api_client/docs/OrganizationApi.md#organizations_organization_id_members_customer_id_role_put) | **PUT** /organizations/{organizationId}/members/{customerId}/role | Sets the given member&#39;s org-scoped role.
...
*OrganizationApi* | [**organizations_organization_id_support_slack_channel_put**](rapidata/api_client/docs/OrganizationApi.md#organizations_organization_id_support_slack_channel_put) | **PUT** /organizations/{organizationId}/support-slack-channel | Sets the support Slack channel URL for the given organization.
...
*OwnerTierOverrideApi* | [**campaign_owner_tier_organizations_organization_id_get**](rapidata/api_client/docs/OwnerTierOverrideApi.md#campaign_owner_tier_organizations_organization_id_get) | **GET** /campaign/owner-tier/organizations/{organizationId} | Returns the priority and global boost level an organization&#39;s campaigns are created with.
...
*ParticipantApi* | [**participants_submit_post**](rapidata/api_client/docs/ParticipantApi.md#participants_submit_post) | **POST** /participants/submit | Submits several participants of one benchmark together, so they are evaluated as one batch.
...
*PromptApi* | [**benchmark_prompt_prompt_id_segments_put**](rapidata/api_client/docs/PromptApi.md#benchmark_prompt_prompt_id_segments_put) | **PUT** /benchmark-prompt/{promptId}/segments | Replaces a prompt&#39;s content with the submitted segments.
*PromptApi* | [**benchmark_prompt_prompt_id_tags_put**](rapidata/api_client/docs/PromptApi.md#benchmark_prompt_prompt_id_tags_put) | **PUT** /benchmark-prompt/{promptId}/tags | Updates the tags and origin associated with a prompt.
*PromptEmbeddingMapApi* | [**benchmark_benchmark_id_prompt_embedding_map_delete**](rapidata/api_client/docs/PromptEmbeddingMapApi.md#benchmark_benchmark_id_prompt_embedding_map_delete) | **DELETE** /benchmark/{benchmarkId}/prompt-embedding-map | Deletes the benchmark&#39;s prompt embedding map.
*PromptEmbeddingMapApi* | [**benchmark_benchmark_id_prompt_embedding_map_get**](rapidata/api_client/docs/PromptEmbeddingMapApi.md#benchmark_benchmark_id_prompt_embedding_map_get) | **GET** /benchmark/{benchmarkId}/prompt-embedding-map | Returns the benchmark&#39;s prompt embedding map.
*PromptEmbeddingMapApi* | [**benchmark_benchmark_id_prompt_embedding_map_post**](rapidata/api_client/docs/PromptEmbeddingMapApi.md#benchmark_benchmark_id_prompt_embedding_map_post) | **POST** /benchmark/{benchmarkId}/prompt-embedding-map | Starts an asynchronous computation of the benchmark&#39;s prompt embedding map.
*PromptEmbeddingMapApi* | [**benchmark_benchmark_id_prompt_embedding_map_status_get**](rapidata/api_client/docs/PromptEmbeddingMapApi.md#benchmark_benchmark_id_prompt_embedding_map_status_get) | **GET** /benchmark/{benchmarkId}/prompt-embedding-map/status | Returns the state of the benchmark&#39;s most recent prompt embedding map computation.
*RankingFlowApi* | [**flow_ranking_flow_id_patch**](rapidata/api_client/docs/RankingFlowApi.md#flow_ranking_flow_id_patch) | **PATCH** /flow/ranking/{flowId} | Updates the configuration of a ranking flow.
...
*RankingFlowItemApi* | [**flow_ranking_item_flow_item_id_results_get**](rapidata/api_client/docs/RankingFlowItemApi.md#flow_ranking_item_flow_item_id_results_get) | **GET** /flow/ranking/item/{flowItemId}/results | Returns ranking results with Elo scores for a flow item.
...
*ReconciliationApi* | [**billing_reconcile_post**](rapidata/api_client/docs/ReconciliationApi.md#billing_reconcile_post) | **POST** /billing/reconcile | Starts reconciliation for a single billing item, all items for a customer, or all items in a billing group.
*ReconciliationApi* | [**billing_reconciliation_bulk_bulk_reconciliation_id_get**](rapidata/api_client/docs/ReconciliationApi.md#billing_reconciliation_bulk_bulk_reconciliation_id_get) | **GET** /billing/reconciliation/bulk/{bulkReconciliationId} | Returns the aggregated status and results of all reconciliation jobs in a bulk operation.
*ReconciliationApi* | [**billing_reconciliation_bulk_bulk_reconciliation_id_redispatch_post**](rapidata/api_client/docs/ReconciliationApi.md#billing_reconciliation_bulk_bulk_reconciliation_id_redispatch_post) | **POST** /billing/reconciliation/bulk/{bulkReconciliationId}/redispatch | Redispatches the individual reconciliations contained in the given bulk reconciliation.
*ReconciliationApi* | [**billing_reconciliation_job_id_get**](rapidata/api_client/docs/ReconciliationApi.md#billing_reconciliation_job_id_get) | **GET** /billing/reconciliation/{jobId} | Returns the status and results of a reconciliation job.
*ReplicateApi* | [**leaderboard_faucet_replicate_models_get**](rapidata/api_client/docs/ReplicateApi.md#leaderboard_faucet_replicate_models_get) | **GET** /leaderboard/faucet/replicate/models | Searches Replicate models by free-text term.
*ReplicateApi* | [**leaderboard_faucet_replicate_models_model_owner_model_name_get**](rapidata/api_client/docs/ReplicateApi.md#leaderboard_faucet_replicate_models_model_owner_model_name_get) | **GET** /leaderboard/faucet/replicate/models/{modelOwner}/{modelName} | Returns a single Replicate model with its input parameter schema.
...
*SampleGenerationApi* | [**benchmark_benchmark_id_sample_generation_post**](rapidata/api_client/docs/SampleGenerationApi.md#benchmark_benchmark_id_sample_generation_post) | **POST** /benchmark/{benchmarkId}/sample-generation | Starts an asynchronous sample generation run.
*SampleGenerationApi* | [**benchmark_benchmark_id_sample_generation_preview_post**](rapidata/api_client/docs/SampleGenerationApi.md#benchmark_benchmark_id_sample_generation_preview_post) | **POST** /benchmark/{benchmarkId}/sample-generation/preview | Reports how many samples the given configuration would generate, and for which participants.
...
*SettingsApi* | [**billing_billing_item_billing_item_id_settings_post**](rapidata/api_client/docs/SettingsApi.md#billing_billing_item_billing_item_id_settings_post) | **POST** /billing/billing-item/{billingItemId}/settings | Creates a billing setting for a billing item.
*SettingsApi* | [**billing_billing_item_billing_item_id_settings_setting_id_delete**](rapidata/api_client/docs/SettingsApi.md#billing_billing_item_billing_item_id_settings_setting_id_delete) | **DELETE** /billing/billing-item/{billingItemId}/settings/{settingId} | Deletes a billing item billing setting.
*SettingsApi* | [**billing_organization_organization_id_settings_post**](rapidata/api_client/docs/SettingsApi.md#billing_organization_organization_id_settings_post) | **POST** /billing/organization/{organizationId}/settings | Creates a billing setting for an organization.
*SettingsApi* | [**billing_organization_organization_id_settings_setting_id_delete**](rapidata/api_client/docs/SettingsApi.md#billing_organization_organization_id_settings_setting_id_delete) | **DELETE** /billing/organization/{organizationId}/settings/{settingId} | Deletes an organization billing setting.
*SettingsApi* | [**billing_settings_post**](rapidata/api_client/docs/SettingsApi.md#billing_settings_post) | **POST** /billing/settings | Creates a global billing setting.
*SettingsApi* | [**billing_settings_setting_id_delete**](rapidata/api_client/docs/SettingsApi.md#billing_settings_setting_id_delete) | **DELETE** /billing/settings/{settingId} | Deletes a global billing setting.
*SettingsApi* | [**billing_settings_timeline_get**](rapidata/api_client/docs/SettingsApi.md#billing_settings_timeline_get) | **GET** /billing/settings/timeline | Gets the billing settings timeline.
...
*SimpleFlowApi* | [**flow_simple_flow_id_patch**](rapidata/api_client/docs/SimpleFlowApi.md#flow_simple_flow_id_patch) | **PATCH** /flow/simple/{flowId} | Updates the configuration of a simple flow. Changing the blueprint once the flow has items returns 409 Conflict.
*SimpleFlowApi* | [**flow_simple_post**](rapidata/api_client/docs/SimpleFlowApi.md#flow_simple_post) | **POST** /flow/simple | Creates a simple flow that runs one rapid blueprint over every datapoint of its items.
*SimpleFlowItemApi* | [**flow_simple_flow_id_item_post**](rapidata/api_client/docs/SimpleFlowItemApi.md#flow_simple_flow_id_item_post) | **POST** /flow/simple/{flowId}/item | Creates a flow item that labels every datapoint of the dataset with the flow&#39;s blueprint; the dataset holds between 1 and 256 datapoints.
*SimpleFlowItemApi* | [**flow_simple_item_flow_item_id_results_get**](rapidata/api_client/docs/SimpleFlowItemApi.md#flow_simple_item_flow_item_id_results_get) | **GET** /flow/simple/item/{flowItemId}/results | Returns the category distribution and majority per datapoint of a simple flow item.
...
*UserRapidApi* | [**rapid_rapid_id_reports_get**](rapidata/api_client/docs/UserRapidApi.md#rapid_rapid_id_reports_get) | **GET** /rapid/{rapidId}/reports | Queries the reports users submitted for a rapid, including the issue they picked and the message they wrote.
...
*ValidationSetApi* | [**validation_sets_available_get**](rapidata/api_client/docs/ValidationSetApi.md#validation_sets_available_get) | **GET** /validation-sets/available | Gets the available validation sets for the current user&#39;s organization.
...
*VolumeDiscountApi* | [**billing_organization_organization_id_volume_discounts_get**](rapidata/api_client/docs/VolumeDiscountApi.md#billing_organization_organization_id_volume_discounts_get) | **GET** /billing/organization/{organizationId}/volume-discounts | Gets an organization&#39;s current volume discount brackets.
*VolumeDiscountApi* | [**billing_organization_organization_id_volume_discounts_put**](rapidata/api_client/docs/VolumeDiscountApi.md#billing_organization_organization_id_volume_discounts_put) | **PUT** /billing/organization/{organizationId}/volume-discounts | Replaces an organization&#39;s whole volume discount bracket set.
*VolumeDiscountApi* | [**billing_period_billing_period_id_volume_discounts_get**](rapidata/api_client/docs/VolumeDiscountApi.md#billing_period_billing_period_id_volume_discounts_get) | **GET** /billing-period/{billingPeriodId}/volume-discounts | Gets all volume discount brackets for a billing period.


## Documentation For Models

 - [AcceptOrgInvitationByIdEndpointOutput](rapidata/api_client/docs/AcceptOrgInvitationByIdEndpointOutput.md)
 ...
 - [AgeUserFilterAgeGroup](rapidata/api_client/docs/AgeUserFilterAgeGroup.md)
 - [AggregatorType](rapidata/api_client/docs/AggregatorType.md)
 - [ApplyPromptStructureEndpointInput](rapidata/api_client/docs/ApplyPromptStructureEndpointInput.md)
 - [ApplyPromptStructureEndpointOutput](rapidata/api_client/docs/ApplyPromptStructureEndpointOutput.md)
 - [AssetSegmentSource](rapidata/api_client/docs/AssetSegmentSource.md)
 - [AttachCategoryRapidBlueprintCategory](rapidata/api_client/docs/AttachCategoryRapidBlueprintCategory.md)
 - [AttachCategoryRapidCategory](rapidata/api_client/docs/AttachCategoryRapidCategory.md)
 ...
 - [AudienceBoost2](rapidata/api_client/docs/AudienceBoost2.md)
 - [AudienceCapacity](rapidata/api_client/docs/AudienceCapacity.md)
 ...
 - [AudienceScope](rapidata/api_client/docs/AudienceScope.md)
 - [AudienceShareLevel](rapidata/api_client/docs/AudienceShareLevel.md)
 ...
 - [AuthorizationRelationsExternalApp](rapidata/api_client/docs/AuthorizationRelationsExternalApp.md)
 ...
 - [BenchmarkForkStatus](rapidata/api_client/docs/BenchmarkForkStatus.md)
 ...
 - [BulkBillingPeriodCloseState](rapidata/api_client/docs/BulkBillingPeriodCloseState.md)
 - [BulkCloseBillingPeriodsEndpointInput](rapidata/api_client/docs/BulkCloseBillingPeriodsEndpointInput.md)
 - [BulkCloseBillingPeriodsEndpointOutput](rapidata/api_client/docs/BulkCloseBillingPeriodsEndpointOutput.md)
 ...
 - [ChangeExperimentStateEndpointInput](rapidata/api_client/docs/ChangeExperimentStateEndpointInput.md)
 - [ChangeExperimentStateEndpointStateAction](rapidata/api_client/docs/ChangeExperimentStateEndpointStateAction.md)
 - [ChangeOrgMemberRoleEndpointInput](rapidata/api_client/docs/ChangeOrgMemberRoleEndpointInput.md)
 - [ClassifyBlueprintCategory](rapidata/api_client/docs/ClassifyBlueprintCategory.md)
 ...
 - [Client](rapidata/api_client/docs/Client.md)
 - [CloneJobDefinitionEndpointInput](rapidata/api_client/docs/CloneJobDefinitionEndpointInput.md)
 - [CloneJobDefinitionEndpointOutput](rapidata/api_client/docs/CloneJobDefinitionEndpointOutput.md)
 ...
 - [CloseBillingPeriodEndpointInput](rapidata/api_client/docs/CloseBillingPeriodEndpointInput.md)
 - [CloseBillingPeriodEndpointOutput](rapidata/api_client/docs/CloseBillingPeriodEndpointOutput.md)
 ...
 - [CostUnit](rapidata/api_client/docs/CostUnit.md)
 ...
 - [CreateBenchmarkCustomRunsEndpointInput](rapidata/api_client/docs/CreateBenchmarkCustomRunsEndpointInput.md)
 - [CreateBenchmarkCustomRunsEndpointOutput](rapidata/api_client/docs/CreateBenchmarkCustomRunsEndpointOutput.md)
 - [CreateBenchmarkCustomRunsEndpointOutputRun](rapidata/api_client/docs/CreateBenchmarkCustomRunsEndpointOutputRun.md)
 ...
 - [CreateCustomRunEndpointInput](rapidata/api_client/docs/CreateCustomRunEndpointInput.md)
 - [CreateCustomRunEndpointOutput](rapidata/api_client/docs/CreateCustomRunEndpointOutput.md)
 ...
 - [CreateExperimentEndpointInput](rapidata/api_client/docs/CreateExperimentEndpointInput.md)
 - [CreateExperimentEndpointSplit](rapidata/api_client/docs/CreateExperimentEndpointSplit.md)
 ...
 - [CreateJobEndpointCostWarning](rapidata/api_client/docs/CreateJobEndpointCostWarning.md)
 ...
 - [CreateJobShareEndpointInput](rapidata/api_client/docs/CreateJobShareEndpointInput.md)
 ...
 - [CreateOrder](rapidata/api_client/docs/CreateOrder.md)
 - [CreateOrderEndpointOutput](rapidata/api_client/docs/CreateOrderEndpointOutput.md)
 - [CreateOrganizationBillingSettingEndpointInput](rapidata/api_client/docs/CreateOrganizationBillingSettingEndpointInput.md)
 ...
 - [CreatePromptEmbeddingMapEndpointOutput](rapidata/api_client/docs/CreatePromptEmbeddingMapEndpointOutput.md)
 ...
 - [CreateSimpleFlowEndpointInput](rapidata/api_client/docs/CreateSimpleFlowEndpointInput.md)
 - [CreateSimpleFlowEndpointOutput](rapidata/api_client/docs/CreateSimpleFlowEndpointOutput.md)
 - [CreateSimpleFlowItemEndpointInput](rapidata/api_client/docs/CreateSimpleFlowItemEndpointInput.md)
 - [CreateSimpleFlowItemEndpointOutput](rapidata/api_client/docs/CreateSimpleFlowItemEndpointOutput.md)
 ...
 - [Experiment](rapidata/api_client/docs/Experiment.md)
 - [ExperimentAssetKind](rapidata/api_client/docs/ExperimentAssetKind.md)
 - [ExperimentCampaignType](rapidata/api_client/docs/ExperimentCampaignType.md)
 - [ExperimentContextRequirement](rapidata/api_client/docs/ExperimentContextRequirement.md)
 - [ExperimentEligibility](rapidata/api_client/docs/ExperimentEligibility.md)
 - [ExperimentRapidType](rapidata/api_client/docs/ExperimentRapidType.md)
 - [ExperimentScope](rapidata/api_client/docs/ExperimentScope.md)
 - [ExperimentSplit](rapidata/api_client/docs/ExperimentSplit.md)
 - [ExperimentState](rapidata/api_client/docs/ExperimentState.md)
 - [ExperimentUserEligibility](rapidata/api_client/docs/ExperimentUserEligibility.md)
 - [ExperimentUserEnrollment](rapidata/api_client/docs/ExperimentUserEnrollment.md)
 - [ExternalAppId](rapidata/api_client/docs/ExternalAppId.md)
 - [ExternalServiceKind](rapidata/api_client/docs/ExternalServiceKind.md)
 - [FaucetInputBindingInput](rapidata/api_client/docs/FaucetInputBindingInput.md)
 - [FaucetInputBindingOutput](rapidata/api_client/docs/FaucetInputBindingOutput.md)
 ...
 - [GenderUserFilterGender](rapidata/api_client/docs/GenderUserFilterGender.md)
 ...
 - [GetAudienceOrganizationSharesEndpointOutput](rapidata/api_client/docs/GetAudienceOrganizationSharesEndpointOutput.md)
 - [GetAudienceSharesEndpointOutput](rapidata/api_client/docs/GetAudienceSharesEndpointOutput.md)
 ...
 - [GetAvailableValidationSetsEndpointValidationSetOverviewOutput](rapidata/api_client/docs/GetAvailableValidationSetsEndpointValidationSetOverviewOutput.md)
 ...
 - [GetBenchmarkHuggingFaceSyncEndpointOutput](rapidata/api_client/docs/GetBenchmarkHuggingFaceSyncEndpointOutput.md)
 - [GetBenchmarkHuggingFaceSyncHistoryEndpointOutput](rapidata/api_client/docs/GetBenchmarkHuggingFaceSyncHistoryEndpointOutput.md)
 - [GetBenchmarkHuggingFaceSyncHistoryEndpointPagedResultOfOutput](rapidata/api_client/docs/GetBenchmarkHuggingFaceSyncHistoryEndpointPagedResultOfOutput.md)
 - [GetBenchmarkMatchupBreakdownEndpointOutput](rapidata/api_client/docs/GetBenchmarkMatchupBreakdownEndpointOutput.md)
 - [GetBenchmarkMatchupBreakdownEndpointPagedResultOfOutput](rapidata/api_client/docs/GetBenchmarkMatchupBreakdownEndpointPagedResultOfOutput.md)
 ...
 - [GetBenchmarkStandingsByTagEndpointOutput](rapidata/api_client/docs/GetBenchmarkStandingsByTagEndpointOutput.md)
 - [GetBenchmarkStandingsByTagEndpointOutputOutputItem](rapidata/api_client/docs/GetBenchmarkStandingsByTagEndpointOutputOutputItem.md)
 - [GetBenchmarkStandingsByTagEndpointOutputSegment](rapidata/api_client/docs/GetBenchmarkStandingsByTagEndpointOutputSegment.md)
 - [GetBenchmarkStandingsByTagEndpointOutputSegmentItem](rapidata/api_client/docs/GetBenchmarkStandingsByTagEndpointOutputSegmentItem.md)
 ...
 - [GetBulkCloseBillingPeriodsStatusEndpointOutput](rapidata/api_client/docs/GetBulkCloseBillingPeriodsStatusEndpointOutput.md)
 - [GetBulkCloseBillingPeriodsStatusEndpointOutputPeriod](rapidata/api_client/docs/GetBulkCloseBillingPeriodsStatusEndpointOutputPeriod.md)
 - [GetBulkReconciliationStatusEndpointOutput](rapidata/api_client/docs/GetBulkReconciliationStatusEndpointOutput.md)
 - [GetCampaignByIdEndpointICampaignDetails](rapidata/api_client/docs/GetCampaignByIdEndpointICampaignDetails.md)
 - [GetCampaignByIdEndpointICampaignDetailsGetCampaignByIdEndpointProgramCampaignDetails](rapidata/api_client/docs/GetCampaignByIdEndpointICampaignDetailsGetCampaignByIdEndpointProgramCampaignDetails.md)
 - [GetCampaignByIdEndpointICampaignDetailsGetCampaignByIdEndpointRoutedCampaignDetails](rapidata/api_client/docs/GetCampaignByIdEndpointICampaignDetailsGetCampaignByIdEndpointRoutedCampaignDetails.md)
 ...
 - [GetCompatibleValidationSetsEndpointValidationSetOutput](rapidata/api_client/docs/GetCompatibleValidationSetsEndpointValidationSetOutput.md)
 ...
 - [GetExternalAppRelationMembersEndpointCursorPagedResultOfOutput](rapidata/api_client/docs/GetExternalAppRelationMembersEndpointCursorPagedResultOfOutput.md)
 - [GetExternalAppRelationMembersEndpointOutput](rapidata/api_client/docs/GetExternalAppRelationMembersEndpointOutput.md)
 ...
 - [GetJobAbSummaryEndpointOutput](rapidata/api_client/docs/GetJobAbSummaryEndpointOutput.md)
 ...
 - [GetJobDatapointsEndpointOutput](rapidata/api_client/docs/GetJobDatapointsEndpointOutput.md)
 - [GetJobDatapointsEndpointPagedResultOfOutput](rapidata/api_client/docs/GetJobDatapointsEndpointPagedResultOfOutput.md)
 ...
 - [GetJobOrganizationSharesEndpointOutput](rapidata/api_client/docs/GetJobOrganizationSharesEndpointOutput.md)
 - [GetJobProgressEndpointOutput](rapidata/api_client/docs/GetJobProgressEndpointOutput.md)
 - [GetJobResponsesEndpointOutput](rapidata/api_client/docs/GetJobResponsesEndpointOutput.md)
 - [GetJobResponsesEndpointOutputResponse](rapidata/api_client/docs/GetJobResponsesEndpointOutputResponse.md)
 - [GetJobResultNavigationEndpointOutput](rapidata/api_client/docs/GetJobResultNavigationEndpointOutput.md)
 - [GetJobRevisionEndpointOutput](rapidata/api_client/docs/GetJobRevisionEndpointOutput.md)
 - [GetJobSharesEndpointOutput](rapidata/api_client/docs/GetJobSharesEndpointOutput.md)
 ...
 - [GetOrganizationOwnerTierEndpointOutput](rapidata/api_client/docs/GetOrganizationOwnerTierEndpointOutput.md)
 - [GetOrganizationVolumeDiscountsEndpointOutput](rapidata/api_client/docs/GetOrganizationVolumeDiscountsEndpointOutput.md)
 - [GetOrganizationVolumeDiscountsEndpointOutputVolumeDiscountItem](rapidata/api_client/docs/GetOrganizationVolumeDiscountsEndpointOutputVolumeDiscountItem.md)
 - [GetOutstandingCostEndpointOutput](rapidata/api_client/docs/GetOutstandingCostEndpointOutput.md)
 ...
 - [GetPromptEmbeddingMapEndpointOutput](rapidata/api_client/docs/GetPromptEmbeddingMapEndpointOutput.md)
 - [GetPromptEmbeddingMapEndpointOutputPoint](rapidata/api_client/docs/GetPromptEmbeddingMapEndpointOutputPoint.md)
 - [GetPromptEmbeddingMapStatusEndpointOutput](rapidata/api_client/docs/GetPromptEmbeddingMapStatusEndpointOutput.md)
 ...
 - [GetRecommendedValidationSetEndpointValidationSetOutput](rapidata/api_client/docs/GetRecommendedValidationSetEndpointValidationSetOutput.md)
 ...
 - [GetResultsEndpointOutput](rapidata/api_client/docs/GetResultsEndpointOutput.md)
 - [GetResultsEndpointOutputCategoryCount](rapidata/api_client/docs/GetResultsEndpointOutputCategoryCount.md)
 - [GetResultsEndpointOutputDatapoint](rapidata/api_client/docs/GetResultsEndpointOutputDatapoint.md)
 ...
 - [GetSampleGenerationEndpointOutputFailureCount](rapidata/api_client/docs/GetSampleGenerationEndpointOutputFailureCount.md)
 ...
 - [GetSampleNavigationEndpointSample](rapidata/api_client/docs/GetSampleNavigationEndpointSample.md)
 ...
 - [GrantExternalAppRelationEndpointInput](rapidata/api_client/docs/GrantExternalAppRelationEndpointInput.md)
 ...
 - [GroupedRankingGroup](rapidata/api_client/docs/GroupedRankingGroup.md)
 - [HuggingFaceAvailableSegment](rapidata/api_client/docs/HuggingFaceAvailableSegment.md)
 - [HuggingFaceSampleMediaMode](rapidata/api_client/docs/HuggingFaceSampleMediaMode.md)
 - [HuggingFaceSegmentExport](rapidata/api_client/docs/HuggingFaceSegmentExport.md)
 - [HuggingFaceSegmentExportMode](rapidata/api_client/docs/HuggingFaceSegmentExportMode.md)
 - [HuggingFaceSyncOutcome](rapidata/api_client/docs/HuggingFaceSyncOutcome.md)
 - [HuggingFaceSyncStatus](rapidata/api_client/docs/HuggingFaceSyncStatus.md)
 ...
 - [IBillingGroup](rapidata/api_client/docs/IBillingGroup.md)
 - [IBillingGroupAudienceDistillationBillingGroup](rapidata/api_client/docs/IBillingGroupAudienceDistillationBillingGroup.md)
 - [IBillingGroupAudienceJobBillingGroup](rapidata/api_client/docs/IBillingGroupAudienceJobBillingGroup.md)
 - [IBillingGroupBenchmarkBillingGroup](rapidata/api_client/docs/IBillingGroupBenchmarkBillingGroup.md)
 - [IBillingGroupOrderBillingGroup](rapidata/api_client/docs/IBillingGroupOrderBillingGroup.md)
 - [IBillingGroupRankingFlowBillingGroup](rapidata/api_client/docs/IBillingGroupRankingFlowBillingGroup.md)
 - [IBillingGroupValidationSetBillingGroup](rapidata/api_client/docs/IBillingGroupValidationSetBillingGroup.md)
 ...
 - [ICampaignFilterCampaignCooldownFilter](rapidata/api_client/docs/ICampaignFilterCampaignCooldownFilter.md)
 - [ICampaignFilterCampaignIdFilter](rapidata/api_client/docs/ICampaignFilterCampaignIdFilter.md)
 ...
 - [ICampaignFilterDspFilter](rapidata/api_client/docs/ICampaignFilterDspFilter.md)
 ...
 - [ICampaignSelection](rapidata/api_client/docs/ICampaignSelection.md)
 - [ICampaignSelectionAbTestSelection](rapidata/api_client/docs/ICampaignSelectionAbTestSelection.md)
 - [ICampaignSelectionAudienceSelection](rapidata/api_client/docs/ICampaignSelectionAudienceSelection.md)
 - [ICampaignSelectionCappedSelection](rapidata/api_client/docs/ICampaignSelectionCappedSelection.md)
 - [ICampaignSelectionConditionalValidationSelection](rapidata/api_client/docs/ICampaignSelectionConditionalValidationSelection.md)
 - [ICampaignSelectionDemographicSelection](rapidata/api_client/docs/ICampaignSelectionDemographicSelection.md)
 - [ICampaignSelectionEnforcingSelection](rapidata/api_client/docs/ICampaignSelectionEnforcingSelection.md)
 - [ICampaignSelectionLabelingSelection](rapidata/api_client/docs/ICampaignSelectionLabelingSelection.md)
 - [ICampaignSelectionShufflingSelection](rapidata/api_client/docs/ICampaignSelectionShufflingSelection.md)
 - [ICampaignSelectionStaticSelection](rapidata/api_client/docs/ICampaignSelectionStaticSelection.md)
 - [ICampaignSelectionValidationSelection](rapidata/api_client/docs/ICampaignSelectionValidationSelection.md)
 - [ICooldownDuration](rapidata/api_client/docs/ICooldownDuration.md)
 - [ICooldownDurationFixedCooldownDuration](rapidata/api_client/docs/ICooldownDurationFixedCooldownDuration.md)
 - [ICooldownDurationRandomCooldownDuration](rapidata/api_client/docs/ICooldownDurationRandomCooldownDuration.md)
 - [IDatasetCloneDataset](rapidata/api_client/docs/IDatasetCloneDataset.md)
 ...
 - [IFaucetOutputManagedForgeFaucetOutput](rapidata/api_client/docs/IFaucetOutputManagedForgeFaucetOutput.md)
 ...
 - [IFlowRapidBlueprintClassifyBlueprint](rapidata/api_client/docs/IFlowRapidBlueprintClassifyBlueprint.md)
 - [IFlowSimpleFlow](rapidata/api_client/docs/IFlowSimpleFlow.md)
 - [IGraduationRule](rapidata/api_client/docs/IGraduationRule.md)
 - [IGraduationRuleAcceptedFreeTextRule](rapidata/api_client/docs/IGraduationRuleAcceptedFreeTextRule.md)
 ...
 - [IJobResults](rapidata/api_client/docs/IJobResults.md)
 - [IJobResultsGroupedRankingResults](rapidata/api_client/docs/IJobResultsGroupedRankingResults.md)
 - [IJobResultsRankingResults](rapidata/api_client/docs/IJobResultsRankingResults.md)
 - [IJobResultsRapidResults](rapidata/api_client/docs/IJobResultsRapidResults.md)
 ...
 - [ILineItemPlatformFee](rapidata/api_client/docs/ILineItemPlatformFee.md)
 - [ILineItemRefund](rapidata/api_client/docs/ILineItemRefund.md)
 - [ILineItemRunningCost](rapidata/api_client/docs/ILineItemRunningCost.md)
 - [ILineItemVolumeDiscount](rapidata/api_client/docs/ILineItemVolumeDiscount.md)
 ...
 - [IOrderWorkflowInput](rapidata/api_client/docs/IOrderWorkflowInput.md)
 - [IOrderWorkflowInputEvaluationWorkflowInput](rapidata/api_client/docs/IOrderWorkflowInputEvaluationWorkflowInput.md)
 - [IOrderWorkflowInputGroupedRankingWorkflowInput](rapidata/api_client/docs/IOrderWorkflowInputGroupedRankingWorkflowInput.md)
 - [IOrderWorkflowInputSimpleWorkflowInput](rapidata/api_client/docs/IOrderWorkflowInputSimpleWorkflowInput.md)
 ...
 - [IPipelineArtifactCreateDatasetArtifact](rapidata/api_client/docs/IPipelineArtifactCreateDatasetArtifact.md)
 - [IPipelineCreateSimplePipeline](rapidata/api_client/docs/IPipelineCreateSimplePipeline.md)
 - [IPipelineStep](rapidata/api_client/docs/IPipelineStep.md)
 - [IPipelineStepDatasetEvaluationStep](rapidata/api_client/docs/IPipelineStepDatasetEvaluationStep.md)
 - [IPipelineStepSendCompletionMailStep](rapidata/api_client/docs/IPipelineStepSendCompletionMailStep.md)
 - [IPipelineStepWorkflowAggregationStep](rapidata/api_client/docs/IPipelineStepWorkflowAggregationStep.md)
 - [IPipelineStepWorkflowLabelingStep](rapidata/api_client/docs/IPipelineStepWorkflowLabelingStep.md)
 - [IProgramAction](rapidata/api_client/docs/IProgramAction.md)
 - [IProgramActionCompleteAction](rapidata/api_client/docs/IProgramActionCompleteAction.md)
 - [IProgramActionServeRapidAction](rapidata/api_client/docs/IProgramActionServeRapidAction.md)
 - [IProgramNode](rapidata/api_client/docs/IProgramNode.md)
 - [IProgramNodeActionNode](rapidata/api_client/docs/IProgramNodeActionNode.md)
 - [IProgramNodeCasesNode](rapidata/api_client/docs/IProgramNodeCasesNode.md)
 - [IProgramNodeWeightedSplitNode](rapidata/api_client/docs/IProgramNodeWeightedSplitNode.md)
 - [IProgramPredicate](rapidata/api_client/docs/IProgramPredicate.md)
 - [IProgramPredicateAccuracyPredicate](rapidata/api_client/docs/IProgramPredicateAccuracyPredicate.md)
 - [IProgramPredicateAnsweredCountPredicate](rapidata/api_client/docs/IProgramPredicateAnsweredCountPredicate.md)
 - [IProgramPredicateConsecutiveCorrectPredicate](rapidata/api_client/docs/IProgramPredicateConsecutiveCorrectPredicate.md)
 - [IProgramPredicateConsecutiveIncorrectPredicate](rapidata/api_client/docs/IProgramPredicateConsecutiveIncorrectPredicate.md)
 - [IProgramPredicateCorrectCountPredicate](rapidata/api_client/docs/IProgramPredicateCorrectCountPredicate.md)
 - [IProgramPredicateTimeElapsedPredicate](rapidata/api_client/docs/IProgramPredicateTimeElapsedPredicate.md)
 - [IProgramPredicateUserAttributePredicate](rapidata/api_client/docs/IProgramPredicateUserAttributePredicate.md)
 - [IProgramPredicateUserScorePredicate](rapidata/api_client/docs/IProgramPredicateUserScorePredicate.md)
 ...
 - [IRapid](rapidata/api_client/docs/IRapid.md)
 - [IRapidAttachCategoryRapid](rapidata/api_client/docs/IRapidAttachCategoryRapid.md)
 ...
 - [IRapidBoundingBoxRapid](rapidata/api_client/docs/IRapidBoundingBoxRapid.md)
 - [IRapidCompareRapid](rapidata/api_client/docs/IRapidCompareRapid.md)
 - [IRapidFreeTextRapid](rapidata/api_client/docs/IRapidFreeTextRapid.md)
 - [IRapidLineRapid](rapidata/api_client/docs/IRapidLineRapid.md)
 - [IRapidLocateRapid](rapidata/api_client/docs/IRapidLocateRapid.md)
 - [IRapidNamedEntityRapid](rapidata/api_client/docs/IRapidNamedEntityRapid.md)
 ...
 - [IRapidPolygonRapid](rapidata/api_client/docs/IRapidPolygonRapid.md)
 ...
 - [IRapidScrubRapid](rapidata/api_client/docs/IRapidScrubRapid.md)
 - [IRapidTranscriptionRapid](rapidata/api_client/docs/IRapidTranscriptionRapid.md)
 - [IReferee](rapidata/api_client/docs/IReferee.md)
 - [IRefereeBudgetReferee](rapidata/api_client/docs/IRefereeBudgetReferee.md)
 - [IRefereeEarlyStoppingReferee](rapidata/api_client/docs/IRefereeEarlyStoppingReferee.md)
 ...
 - [IRefereeNaiveReferee](rapidata/api_client/docs/IRefereeNaiveReferee.md)
 - [IRefereeQuorumReferee](rapidata/api_client/docs/IRefereeQuorumReferee.md)
 ...
 - [IUserFilter](rapidata/api_client/docs/IUserFilter.md)
 - [IUserFilterAgeUserFilter](rapidata/api_client/docs/IUserFilterAgeUserFilter.md)
 - [IUserFilterAndUserFilter](rapidata/api_client/docs/IUserFilterAndUserFilter.md)
 - [IUserFilterCampaignUserFilter](rapidata/api_client/docs/IUserFilterCampaignUserFilter.md)
 - [IUserFilterCountryUserFilter](rapidata/api_client/docs/IUserFilterCountryUserFilter.md)
 - [IUserFilterCustomUserFilter](rapidata/api_client/docs/IUserFilterCustomUserFilter.md)
 - [IUserFilterDeviceUserFilter](rapidata/api_client/docs/IUserFilterDeviceUserFilter.md)
 - [IUserFilterGenderUserFilter](rapidata/api_client/docs/IUserFilterGenderUserFilter.md)
 - [IUserFilterLanguageUserFilter](rapidata/api_client/docs/IUserFilterLanguageUserFilter.md)
 - [IUserFilterNewUserFilter](rapidata/api_client/docs/IUserFilterNewUserFilter.md)
 - [IUserFilterNotUserFilter](rapidata/api_client/docs/IUserFilterNotUserFilter.md)
 - [IUserFilterOrUserFilter](rapidata/api_client/docs/IUserFilterOrUserFilter.md)
 - [IUserFilterResponseCountUserFilter](rapidata/api_client/docs/IUserFilterResponseCountUserFilter.md)
 - [IUserFilterUserScoreUserFilter](rapidata/api_client/docs/IUserFilterUserScoreUserFilter.md)
 ...
 - [IValidationTruthClassifyTruth](rapidata/api_client/docs/IValidationTruthClassifyTruth.md)
 ...
 - [JobNavigationItem](rapidata/api_client/docs/JobNavigationItem.md)
 - [JobRapidResult](rapidata/api_client/docs/JobRapidResult.md)
 - [JobResponse](rapidata/api_client/docs/JobResponse.md)
 - [JobScope](rapidata/api_client/docs/JobScope.md)
 - [JobShareLevel](rapidata/api_client/docs/JobShareLevel.md)
 - [JsonWebKey](rapidata/api_client/docs/JsonWebKey.md)
 - [JsonWebKeySet](rapidata/api_client/docs/JsonWebKeySet.md)
 - [LabelingState](rapidata/api_client/docs/LabelingState.md)
 ...
 - [ListMyOrgInvitationsEndpointOutput](rapidata/api_client/docs/ListMyOrgInvitationsEndpointOutput.md)
 - [ListMyOrgInvitationsEndpointOutputInvitation](rapidata/api_client/docs/ListMyOrgInvitationsEndpointOutputInvitation.md)
 - [ListOrgInvitationsEndpointOutput](rapidata/api_client/docs/ListOrgInvitationsEndpointOutput.md)
 - [ListOrgInvitationsEndpointOutputInvitation](rapidata/api_client/docs/ListOrgInvitationsEndpointOutputInvitation.md)
 ...
 - [LocateBoxTruthBox](rapidata/api_client/docs/LocateBoxTruthBox.md)
 ...
 - [MatchupConfig](rapidata/api_client/docs/MatchupConfig.md)
 - [MatchupZone](rapidata/api_client/docs/MatchupZone.md)
 - [MembershipStatus](rapidata/api_client/docs/MembershipStatus.md)
 - [ModelLicenseType](rapidata/api_client/docs/ModelLicenseType.md)
 - [NamedEntityResultNamedClassification](rapidata/api_client/docs/NamedEntityResultNamedClassification.md)
 - [NamedEntityTruthNamedClassification](rapidata/api_client/docs/NamedEntityTruthNamedClassification.md)
 - [OrderState](rapidata/api_client/docs/OrderState.md)
 - [OrgRole](rapidata/api_client/docs/OrgRole.md)
 - [Origin](rapidata/api_client/docs/Origin.md)
 - [PagedResultOfIBillingGroup](rapidata/api_client/docs/PagedResultOfIBillingGroup.md)
 ...
 - [PreviewSampleGenerationEndpointInput](rapidata/api_client/docs/PreviewSampleGenerationEndpointInput.md)
 - [PreviewSampleGenerationEndpointOutput](rapidata/api_client/docs/PreviewSampleGenerationEndpointOutput.md)
 - [PreviewSampleGenerationEndpointOutputParticipant](rapidata/api_client/docs/PreviewSampleGenerationEndpointOutputParticipant.md)
 - [ProblemDetails](rapidata/api_client/docs/ProblemDetails.md)
 - [ProgramCase](rapidata/api_client/docs/ProgramCase.md)
 - [ProgramComparison](rapidata/api_client/docs/ProgramComparison.md)
 - [PromptEmbeddingMapStatus](rapidata/api_client/docs/PromptEmbeddingMapStatus.md)
 - [PromptSegment](rapidata/api_client/docs/PromptSegment.md)
 - [PromptSegmentDefinition](rapidata/api_client/docs/PromptSegmentDefinition.md)
 - [PromptSegmentInput](rapidata/api_client/docs/PromptSegmentInput.md)
 - [PromptSegmentKind](rapidata/api_client/docs/PromptSegmentKind.md)
 - [PromptTextLanguage](rapidata/api_client/docs/PromptTextLanguage.md)
 ...
 - [QueryCombinedMatrixByBenchmarksEndpointOutput](rapidata/api_client/docs/QueryCombinedMatrixByBenchmarksEndpointOutput.md)
 - [QueryCombinedMatrixByLeaderboardsEndpointOutput](rapidata/api_client/docs/QueryCombinedMatrixByLeaderboardsEndpointOutput.md)
 - [QueryCombinedStandingsByBenchmarksEndpointOutput](rapidata/api_client/docs/QueryCombinedStandingsByBenchmarksEndpointOutput.md)
 - [QueryCombinedStandingsByBenchmarksEndpointOutputItem](rapidata/api_client/docs/QueryCombinedStandingsByBenchmarksEndpointOutputItem.md)
 - [QueryCombinedStandingsByLeaderboardsEndpointOutput](rapidata/api_client/docs/QueryCombinedStandingsByLeaderboardsEndpointOutput.md)
 - [QueryCombinedStandingsByLeaderboardsEndpointOutputItem](rapidata/api_client/docs/QueryCombinedStandingsByLeaderboardsEndpointOutputItem.md)
 ...
 - [QueryManagedBenchmarksEndpointOutput](rapidata/api_client/docs/QueryManagedBenchmarksEndpointOutput.md)
 - [QueryManagedBenchmarksEndpointPagedResultOfOutput](rapidata/api_client/docs/QueryManagedBenchmarksEndpointPagedResultOfOutput.md)
 - [QueryMatchupsByBenchmarkEndpointOutput](rapidata/api_client/docs/QueryMatchupsByBenchmarkEndpointOutput.md)
 - [QueryMatchupsByBenchmarkEndpointOutputCorpus](rapidata/api_client/docs/QueryMatchupsByBenchmarkEndpointOutputCorpus.md)
 - [QueryMatchupsByBenchmarkEndpointOutputLeaderboard](rapidata/api_client/docs/QueryMatchupsByBenchmarkEndpointOutputLeaderboard.md)
 - [QueryMatchupsByBenchmarkEndpointOutputMatchup](rapidata/api_client/docs/QueryMatchupsByBenchmarkEndpointOutputMatchup.md)
 - [QueryMatchupsByBenchmarkEndpointOutputPromptDetails](rapidata/api_client/docs/QueryMatchupsByBenchmarkEndpointOutputPromptDetails.md)
 - [QueryMatchupsByBenchmarkEndpointOutputSide](rapidata/api_client/docs/QueryMatchupsByBenchmarkEndpointOutputSide.md)
 - [QueryMatrixByBenchmarkEndpointOutput](rapidata/api_client/docs/QueryMatrixByBenchmarkEndpointOutput.md)
 - [QueryMatrixByLeaderboardEndpointOutput](rapidata/api_client/docs/QueryMatrixByLeaderboardEndpointOutput.md)
 ...
 - [QueryPromptRatingsByBenchmarkEndpointOutput](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutput.md)
 - [QueryPromptRatingsByBenchmarkEndpointOutputCorpus](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutputCorpus.md)
 - [QueryPromptRatingsByBenchmarkEndpointOutputEntry](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutputEntry.md)
 - [QueryPromptRatingsByBenchmarkEndpointOutputEntryImage](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutputEntryImage.md)
 - [QueryPromptRatingsByBenchmarkEndpointOutputMatrix](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutputMatrix.md)
 - [QueryPromptRatingsByBenchmarkEndpointOutputPrompt](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutputPrompt.md)
 - [QueryPromptRatingsByBenchmarkEndpointOutputPromptDetails](rapidata/api_client/docs/QueryPromptRatingsByBenchmarkEndpointOutputPromptDetails.md)
 ...
 - [QueryReportsEndpointOutput](rapidata/api_client/docs/QueryReportsEndpointOutput.md)
 - [QueryReportsEndpointPagedResultOfOutput](rapidata/api_client/docs/QueryReportsEndpointPagedResultOfOutput.md)
 ...
 - [QueryStandingsByBenchmarkEndpointOutput](rapidata/api_client/docs/QueryStandingsByBenchmarkEndpointOutput.md)
 - [QueryStandingsByBenchmarkEndpointOutputItem](rapidata/api_client/docs/QueryStandingsByBenchmarkEndpointOutputItem.md)
 - [QueryStandingsByLeaderboardEndpointOutput](rapidata/api_client/docs/QueryStandingsByLeaderboardEndpointOutput.md)
 - [QueryStandingsByLeaderboardEndpointOutputItem](rapidata/api_client/docs/QueryStandingsByLeaderboardEndpointOutputItem.md)
 ...
 - [RankingDatapoint](rapidata/api_client/docs/RankingDatapoint.md)
 - [RankingResults](rapidata/api_client/docs/RankingResults.md)
 - [RapidContextProjection](rapidata/api_client/docs/RapidContextProjection.md)
 - [RapidIssue](rapidata/api_client/docs/RapidIssue.md)
 - [RapidState](rapidata/api_client/docs/RapidState.md)
 - [RatingGrouping](rapidata/api_client/docs/RatingGrouping.md)
 ...
 - [RebalanceLeaderboardEndpointInput](rapidata/api_client/docs/RebalanceLeaderboardEndpointInput.md)
 ...
 - [ReplacePromptSegmentsEndpointInput](rapidata/api_client/docs/ReplacePromptSegmentsEndpointInput.md)
 ...
 - [ResettleBillingPeriodEndpointInput](rapidata/api_client/docs/ResettleBillingPeriodEndpointInput.md)
 - [ResettleBillingPeriodEndpointOutput](rapidata/api_client/docs/ResettleBillingPeriodEndpointOutput.md)
 ...
 - [RevokeExternalAppRelationEndpointInput](rapidata/api_client/docs/RevokeExternalAppRelationEndpointInput.md)
 ...
 - [SampleGenerationItemFailureCategory](rapidata/api_client/docs/SampleGenerationItemFailureCategory.md)
 - [SampleGenerationItemStatus](rapidata/api_client/docs/SampleGenerationItemStatus.md)
 - [SampleGenerationMode](rapidata/api_client/docs/SampleGenerationMode.md)
 - [SampleGenerationStatus](rapidata/api_client/docs/SampleGenerationStatus.md)
 - [ScrubTruthScrubRange](rapidata/api_client/docs/ScrubTruthScrubRange.md)
 ...
 - [SetOrganizationCreditLineEndpointInput](rapidata/api_client/docs/SetOrganizationCreditLineEndpointInput.md)
 ...
 - [SetVolumeDiscountsEndpointInput](rapidata/api_client/docs/SetVolumeDiscountsEndpointInput.md)
 - [SetVolumeDiscountsEndpointInputBracket](rapidata/api_client/docs/SetVolumeDiscountsEndpointInputBracket.md)
 - [ShareAudienceWithCustomerEndpointInput](rapidata/api_client/docs/ShareAudienceWithCustomerEndpointInput.md)
 - [ShareAudienceWithOrganizationEndpointInput](rapidata/api_client/docs/ShareAudienceWithOrganizationEndpointInput.md)
 - [ShareJobWithOrganizationEndpointInput](rapidata/api_client/docs/ShareJobWithOrganizationEndpointInput.md)
 ...
 - [StartBenchmarkHuggingFaceSyncEndpointInput](rapidata/api_client/docs/StartBenchmarkHuggingFaceSyncEndpointInput.md)
 - [StartBenchmarkHuggingFaceSyncEndpointOutput](rapidata/api_client/docs/StartBenchmarkHuggingFaceSyncEndpointOutput.md)
 ...
 - [SubmitLeaderboardParticipantEndpointOutput](rapidata/api_client/docs/SubmitLeaderboardParticipantEndpointOutput.md)
 ...
 - [SubmitParticipantEndpointMinAssetsPerPromptWarning](rapidata/api_client/docs/SubmitParticipantEndpointMinAssetsPerPromptWarning.md)
 - [SubmitParticipantEndpointOutput](rapidata/api_client/docs/SubmitParticipantEndpointOutput.md)
 - [SubmitParticipantEndpointUnderfilledPrompt](rapidata/api_client/docs/SubmitParticipantEndpointUnderfilledPrompt.md)
 - [SubmitParticipantsEndpointBatchMinAssetsPerPromptWarning](rapidata/api_client/docs/SubmitParticipantsEndpointBatchMinAssetsPerPromptWarning.md)
 - [SubmitParticipantsEndpointInput](rapidata/api_client/docs/SubmitParticipantsEndpointInput.md)
 - [SubmitParticipantsEndpointOutput](rapidata/api_client/docs/SubmitParticipantsEndpointOutput.md)
 - [SubmitParticipantsEndpointParticipantUnderfilledPrompts](rapidata/api_client/docs/SubmitParticipantsEndpointParticipantUnderfilledPrompts.md)
 - [SubmitParticipantsEndpointUnderfilledPrompt](rapidata/api_client/docs/SubmitParticipantsEndpointUnderfilledPrompt.md)
 - [SubscribeToNewsletterEndpointInput](rapidata/api_client/docs/SubscribeToNewsletterEndpointInput.md)
 - [SwitchActiveOrganizationEndpointInput](rapidata/api_client/docs/SwitchActiveOrganizationEndpointInput.md)
 - [Tag](rapidata/api_client/docs/Tag.md)
 - [TagSummary](rapidata/api_client/docs/TagSummary.md)
 - [TextSegmentSource](rapidata/api_client/docs/TextSegmentSource.md)
 - [TimeGrouping](rapidata/api_client/docs/TimeGrouping.md)
 - [TranscriptionPayloadTranscriptionWord](rapidata/api_client/docs/TranscriptionPayloadTranscriptionWord.md)
 - [TranscriptionRapidTranscriptionWord](rapidata/api_client/docs/TranscriptionRapidTranscriptionWord.md)
 - [TranscriptionResultTranscriptionWord](rapidata/api_client/docs/TranscriptionResultTranscriptionWord.md)
 - [TranscriptionTruthTranscriptionWord](rapidata/api_client/docs/TranscriptionTruthTranscriptionWord.md)
 ...
 - [UpdateExperimentEndpointInput](rapidata/api_client/docs/UpdateExperimentEndpointInput.md)
 ...
 - [UpdateSimpleFlowConfigEndpointInput](rapidata/api_client/docs/UpdateSimpleFlowConfigEndpointInput.md)
 ...
 - [UserAttribute](rapidata/api_client/docs/UserAttribute.md)
 ...
 - [WeightedBranch](rapidata/api_client/docs/WeightedBranch.md)
